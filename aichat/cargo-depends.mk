...
CARGO_CRATE_DEPENDS+=	anndists-0.1.2
...
CARGO_CRATE_DEPENDS+=	aws-smithy-eventstream-0.60.4
CARGO_CRATE_DEPENDS+=	aws-smithy-types-1.2.0
...
CARGO_CRATE_DEPENDS+=	bytes-1.7.0
...
CARGO_CRATE_DEPENDS+=	generator-0.8.2
...
CARGO_CRATE_DEPENDS+=	hnsw_rs-0.3.0
CARGO_CRATE_DEPENDS+=	home-0.5.9
CARGO_CRATE_DEPENDS+=	html2text-0.12.5
...
CARGO_CRATE_DEPENDS+=	ppv-lite86-0.2.18
...
CARGO_CRATE_DEPENDS+=	tokio-graceful-0.1.6
