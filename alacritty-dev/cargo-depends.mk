...
CARGO_CRATE_DEPENDS+=	android-activity-0.5.0-beta.1
...
CARGO_CRATE_DEPENDS+=	cursor-icon-1.0.0
...
CARGO_CRATE_DEPENDS+=	ndk-0.8.0-beta.0
CARGO_CRATE_DEPENDS+=	ndk-context-0.1.1
CARGO_CRATE_DEPENDS+=	ndk-sys-0.5.0-beta.0+25.2.9519653
...
CARGO_CRATE_DEPENDS+=	sctk-adwaita-0.6.1
...
CARGO_CRATE_DEPENDS+=	smithay-client-toolkit-0.17.0
...
CARGO_CRATE_DEPENDS+=	tiny-skia-0.11.1
CARGO_CRATE_DEPENDS+=	tiny-skia-path-0.11.1
...
CARGO_CRATE_DEPENDS+=	vte-0.12.0
...
CARGO_CRATE_DEPENDS+=	wayland-cursor-0.30.0
CARGO_CRATE_DEPENDS+=	wayland-protocols-0.29.5
CARGO_CRATE_DEPENDS+=	wayland-protocols-0.30.0
CARGO_CRATE_DEPENDS+=	wayland-protocols-wlr-0.1.0
...
CARGO_CRATE_DEPENDS+=	web-time-0.2.0
...
CARGO_CRATE_DEPENDS+=	winit-0.29.1-beta
...
CARGO_CRATE_DEPENDS+=	xkbcommon-dl-0.4.0
