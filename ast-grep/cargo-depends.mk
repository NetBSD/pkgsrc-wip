...
CARGO_CRATE_DEPENDS+=	napi-2.13.2
CARGO_CRATE_DEPENDS+=	napi-build-2.0.1
CARGO_CRATE_DEPENDS+=	napi-derive-2.13.0
CARGO_CRATE_DEPENDS+=	napi-derive-backend-1.0.52
CARGO_CRATE_DEPENDS+=	napi-sys-2.2.3
...
CARGO_CRATE_DEPENDS+=	tree-sitter-css-0.19.0
CARGO_CRATE_DEPENDS+=	tree-sitter-dart-0.0.3
CARGO_CRATE_DEPENDS+=	tree-sitter-facade-sg-0.9.2
CARGO_CRATE_DEPENDS+=	tree-sitter-go-0.19.1
CARGO_CRATE_DEPENDS+=	tree-sitter-html-0.19.0
CARGO_CRATE_DEPENDS+=	tree-sitter-java-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-javascript-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-json-0.19.0
CARGO_CRATE_DEPENDS+=	tree-sitter-kotlin-0.2.11
CARGO_CRATE_DEPENDS+=	tree-sitter-lua-0.0.18
CARGO_CRATE_DEPENDS+=	tree-sitter-python-0.20.3
CARGO_CRATE_DEPENDS+=	tree-sitter-ruby-0.20.0
CARGO_CRATE_DEPENDS+=	tree-sitter-rust-0.20.3
CARGO_CRATE_DEPENDS+=	tree-sitter-scala-0.20.1
CARGO_CRATE_DEPENDS+=	tree-sitter-swift-0.3.6
CARGO_CRATE_DEPENDS+=	tree-sitter-thrift-0.5.0
CARGO_CRATE_DEPENDS+=	tree-sitter-typescript-0.20.2
