...
CARGO_CRATE_DEPENDS+=	atuin-vt100-0.19.1
...
CARGO_CRATE_DEPENDS+=	byteview-0.10.2
...
CARGO_CRATE_DEPENDS+=	compare-0.0.6
...
CARGO_CRATE_DEPENDS+=	divan-0.1.21
CARGO_CRATE_DEPENDS+=	divan-macros-0.1.21
...
CARGO_CRATE_DEPENDS+=	eye_declare-0.7.1
CARGO_CRATE_DEPENDS+=	eye_declare_engine-0.7.1
...
CARGO_CRATE_DEPENDS+=	fjall-3.1.10
...
CARGO_CRATE_DEPENDS+=	frizbee-0.13.0
...
CARGO_CRATE_DEPENDS+=	locked-tripwire-0.1.1
...
CARGO_CRATE_DEPENDS+=	lsm-tree-3.1.10
...
CARGO_CRATE_DEPENDS+=	norm-0.1.1
...
CARGO_CRATE_DEPENDS+=	protox-0.9.1
CARGO_CRATE_DEPENDS+=	protox-parse-0.9.0
...
CARGO_CRATE_DEPENDS+=	quick_cache-0.6.24
...
CARGO_CRATE_DEPENDS+=	reqwest-middleware-0.5.2
CARGO_CRATE_DEPENDS+=	ring-0.17.14
CARGO_CRATE_DEPENDS+=	rmcp-3.3.0
...
CARGO_CRATE_DEPENDS+=	runtime-format-0.1.3
...
CARGO_CRATE_DEPENDS+=	rusty_paserk-0.5.0
CARGO_CRATE_DEPENDS+=	rusty_paseto-0.8.0
...
CARGO_CRATE_DEPENDS+=	sql-builder-3.1.1
...
CARGO_CRATE_DEPENDS+=	tiny-bip39-2.0.0
...
CARGO_CRATE_DEPENDS+=	tui-textarea-2-0.13.2
...
CARGO_CRATE_DEPENDS+=	varint-rs-2.2.1
