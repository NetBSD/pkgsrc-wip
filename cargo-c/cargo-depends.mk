...
CARGO_CRATE_DEPENDS+=	cargo-0.80.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.5
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.5
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.5
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.5
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.8
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.12
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.3.1
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.2
...
CARGO_CRATE_DEPENDS+=	gix-command-0.3.7
...
CARGO_CRATE_DEPENDS+=	gix-filter-0.11.2
...
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.13.1
...
CARGO_CRATE_DEPENDS+=	gix-pathspec-0.7.5
CARGO_CRATE_DEPENDS+=	gix-prompt-0.8.5
CARGO_CRATE_DEPENDS+=	gix-protocol-0.45.1
...
CARGO_CRATE_DEPENDS+=	gix-transport-0.42.1
...
CARGO_CRATE_DEPENDS+=	gix-worktree-0.34.0
...
CARGO_CRATE_DEPENDS+=	rustfix-0.8.4
