...
CARGO_CRATE_DEPENDS+=	cargo-0.85.0
CARGO_CRATE_DEPENDS+=	cargo-credential-0.4.8
CARGO_CRATE_DEPENDS+=	cargo-credential-libsecret-0.4.10
CARGO_CRATE_DEPENDS+=	cargo-credential-macos-keychain-0.4.10
CARGO_CRATE_DEPENDS+=	cargo-credential-wincred-0.4.10
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.9
CARGO_CRATE_DEPENDS+=	cargo-util-0.2.17
CARGO_CRATE_DEPENDS+=	cargo-util-schemas-0.7.1
...
CARGO_CRATE_DEPENDS+=	crates-io-0.40.7
...
CARGO_CRATE_DEPENDS+=	gix-negotiate-0.16.0
...
CARGO_CRATE_DEPENDS+=	gix-protocol-0.46.1
...
CARGO_CRATE_DEPENDS+=	gix-submodule-0.15.0
CARGO_CRATE_DEPENDS+=	gix-tempfile-15.0.0
CARGO_CRATE_DEPENDS+=	gix-trace-0.1.12
CARGO_CRATE_DEPENDS+=	gix-transport-0.43.1
...
CARGO_CRATE_DEPENDS+=	implib-0.3.4
...
CARGO_CRATE_DEPENDS+=	jiff-0.1.24
...
CARGO_CRATE_DEPENDS+=	serde_json-1.0.136
