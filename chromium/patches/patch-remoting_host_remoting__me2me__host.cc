...
--- remoting/host/remoting_me2me_host.cc.orig	2026-01-07 00:50:30.000000000 +0000
...
@@ -201,7 +201,7 @@ const char kApplicationName[] = "chromot
...
@@ -449,7 +449,7 @@ class HostProcess : public ConfigWatcher
...
+#if BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 ...
 #endif  // BUILDFLAG(IS_LINUX) || BUILDFLAG(IS_CHROMEOS)
@@ -511,7 +511,7 @@ class HostProcess : public ConfigWatcher
...
@@ -915,7 +915,7 @@ void HostProcess::CreateAuthenticatorFac
