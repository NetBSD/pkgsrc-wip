...
--- third_party/blink/renderer/platform/fonts/skia/font_cache_skia.cc.orig	2025-09-29 17:05:47.000000000 +0000
...
@@ -256,7 +256,7 @@ const FontPlatformData* FontCache::Creat
   std::string name;
