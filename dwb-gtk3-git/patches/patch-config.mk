$NetBSD: patch-config.mk,v 1.1 2015/09/01 23:24:55 f8l Exp $
...
--- config.mk.orig	2015-05-24 10:10:47.000000000 +0000
+++ config.mk
@@ -50,14 +50,14 @@ TARGET = $(REAL_NAME)
...
+MANDIR?=$(DATAROOTDIR)/man
 ...
 MAN7DIR=$(MANDIR)/man7
 MANAPI=dwb-js.7
@@ -153,12 +153,10 @@ BASE_SCRIPT=base.js
 CFLAGS := $(CFLAGS)
 CFLAGS += -Wall 
...
@@ -167,21 +165,21 @@ CFLAGS += -D__BSD_VISIBLE
