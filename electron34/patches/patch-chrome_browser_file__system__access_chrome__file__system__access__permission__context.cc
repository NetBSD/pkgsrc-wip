...
--- chrome/browser/file_system_access/chrome_file_system_access_permission_context.cc.orig	2025-02-24 19:59:26.000000000 +0000
...
@@ -252,128 +251,10 @@ bool MaybeIsLocalUNCPath(const base::Fil
 }
 #endif
