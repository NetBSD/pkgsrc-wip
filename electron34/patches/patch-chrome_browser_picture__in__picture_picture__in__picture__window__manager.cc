...
--- chrome/browser/picture_in_picture/picture_in_picture_window_manager.cc.orig	2025-02-24 19:59:26.000000000 +0000
...
@@ -190,7 +193,7 @@ bool PictureInPictureWindowManager::Exit
     return false;
   }
...
@@ -386,7 +389,7 @@ gfx::Size PictureInPictureWindowManager:
...
@@ -474,6 +477,7 @@ PictureInPictureWindowManager::GetOverla
     return nullptr;
   }
...
+#if BUILDFLAG(GOOGLE_CHROME_BRANDING)
   ...
   //
@@ -512,6 +516,8 @@ PictureInPictureWindowManager::GetOverla
   }
