...
CARGO_CRATE_DEPENDS+=	attohttpc-0.24.1
CARGO_CRATE_DEPENDS+=	autocfg-1.4.0
CARGO_CRATE_DEPENDS+=	automerge-0.6.1
...
CARGO_CRATE_DEPENDS+=	futures-buffered-0.2.11
...
CARGO_CRATE_DEPENDS+=	hmac-sha256-1.1.12
...
CARGO_CRATE_DEPENDS+=	igd-next-0.16.1
...
CARGO_CRATE_DEPENDS+=	magic-wormhole-0.7.6
...
CARGO_CRATE_DEPENDS+=	nested_enum_utils-0.2.2
...
CARGO_CRATE_DEPENDS+=	noise-protocol-0.2.0
...
CARGO_CRATE_DEPENDS+=	pkarr-3.7.2
...
CARGO_CRATE_DEPENDS+=	reqwest-0.12.18
...
CARGO_CRATE_DEPENDS+=	snafu-0.8.6
CARGO_CRATE_DEPENDS+=	snafu-derive-0.8.6
...
CARGO_CRATE_DEPENDS+=	surge-ping-0.8.2
...
CARGO_CRATE_DEPENDS+=	ws_stream_wasm-0.7.4
