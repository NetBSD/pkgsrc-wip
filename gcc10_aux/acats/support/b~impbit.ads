...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_impbit" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9cd32b5f#;
   pragma Export (C, u00001, "impbitB");
