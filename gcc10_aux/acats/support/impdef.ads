...
--=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====--
   ...
   Minimum_Task_Switch : constant Duration := 0.010;
   --                                         ^^^ --- MODIFY HERE AS NEEDED
...
--=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====--
   ...
   Switch_To_New_Task : constant Duration := 0.010;
   --                                        ^^^ -- MODIFY HERE AS NEEDED
...
--=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====-=====--
   ...
   pragma Linker_Options ("/home/fernando/mysandboxfolder/tmp/acats/support/cd300051.o");
