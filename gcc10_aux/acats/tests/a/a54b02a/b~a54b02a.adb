pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~a54b02a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~a54b02a.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_a54b02a");
