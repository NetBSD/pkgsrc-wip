...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_a74205e" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#91cd9700#;
   pragma Export (C, u00001, "a74205eB");
   ...
   u00121 : constant Version_32 := 16#0f54639a#;
