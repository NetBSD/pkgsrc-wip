pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~a87b59a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~a87b59a.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_a87b59a");
