pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~b452001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~b452001.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "b452001_0_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "b452001_0__finalize_spec");
      begin
         E102 := E102 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "system__finalization_masters__finalize_spec");
      begin
         F2;
      end;
      declare
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_b452001");
