pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~b854005.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~b854005.adb");
...
package body ada_main is
   ...
   E097 : Short_Integer; pragma Import (Ada, E097, "b854005a_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "b854005a__finalize_spec");
      begin
         F1;
      end;
      declare
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_b854005");
