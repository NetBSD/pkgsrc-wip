pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~bd8004a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~bd8004a.adb");
...
package body ada_main is
   ...
   E83 : Short_Integer; pragma Import (Ada, E83, "system__object_reader_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_bd8004a");
