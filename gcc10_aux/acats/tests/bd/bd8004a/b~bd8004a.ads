...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bd8004a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#532f3f40#;
   pragma Export (C, u00001, "bd8004aB");
   ...
   u00007 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00007, "system__memoryB");
   u00008 : constant Version_32 := 16#ff2a7423#;
