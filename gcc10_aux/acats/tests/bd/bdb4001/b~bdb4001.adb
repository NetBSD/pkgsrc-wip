pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~bdb4001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~bdb4001.adb");
...
package body ada_main is
   ...
   E115 : Short_Integer; pragma Import (Ada, E115, "system__storage_pools_E");
   ...
   E117 : Short_Integer; pragma Import (Ada, E117, "system__pool_global_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "system__pool_size_E");
   E104 : Short_Integer; pragma Import (Ada, E104, "bdb4001_tracked_subpools_E");
   E102 : Short_Integer; pragma Import (Ada, E102, "bdb4001_package_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "bdb4001_package__finalize_spec");
      begin
         E102 := E102 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "bdb4001_tracked_subpools__finalize_body");
      begin
         E104 := E104 - 1;
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "bdb4001_tracked_subpools__finalize_spec");
      begin
         F3;
      end;
      E125 := E125 - 1;
   ...
   begin
      ...
      E125 := E125 + 1;
      Bdb4001_Tracked_Subpools'Elab_Spec;
      Bdb4001_Tracked_Subpools'Elab_Body;
      E104 := E104 + 1;
      Bdb4001_Package'Elab_Spec;
      E102 := E102 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_bdb4001");
