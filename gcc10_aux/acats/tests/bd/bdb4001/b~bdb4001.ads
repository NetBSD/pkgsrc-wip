...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bdb4001" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3fb8d947#;
   pragma Export (C, u00001, "bdb4001B");
   ...
   u00102 : constant Version_32 := 16#6b60049d#;
   pragma Export (C, u00102, "bdb4001_packageS");
   u00103 : constant Version_32 := 16#a3d0fa37#;
   pragma Export (C, u00103, "bdb4001_tracked_subpoolsB");
   u00104 : constant Version_32 := 16#93761416#;
   pragma Export (C, u00104, "bdb4001_tracked_subpoolsS");
   u00105 : constant Version_32 := 16#57674f80#;
   pragma Export (C, u00105, "system__finalization_mastersB");
   u00106 : constant Version_32 := 16#fdab2bdd#;
   ...
   u00108 : constant Version_32 := 16#538e63fc#;
   ...
   u00114 : constant Version_32 := 16#6d4d969a#;
   pragma Export (C, u00114, "system__storage_poolsB");
   u00115 : constant Version_32 := 16#85ba8cba#;
   pragma Export (C, u00115, "system__storage_poolsS");
   u00116 : constant Version_32 := 16#5a895de2#;
   pragma Export (C, u00116, "system__pool_globalB");
   u00117 : constant Version_32 := 16#7141203e#;
   pragma Export (C, u00117, "system__pool_globalS");
   u00118 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00118, "system__memoryB");
   u00119 : constant Version_32 := 16#ff2a7423#;
   pragma Export (C, u00119, "system__memoryS");
   u00120 : constant Version_32 := 16#a02f73f2#;
   ...
   --  system.pool_size%s
   --  system.pool_size%b
   --  bdb4001_tracked_subpools%s
   --  bdb4001_tracked_subpools%b
   --  bdb4001_package%s
   --  bdb4001%b
