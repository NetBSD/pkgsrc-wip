...
--      using the Ada 2012 index notation for Hashed_Sets. We also check that
...
begin
   ...
   declare
      ...
      My_Reference : My_Hashed_Sets.Reference_Type :=
                              My_Set_1.Reference
   ...
   begin
      ...
      Test_and_Mod (
            Value    =>
               My_Hashed_Sets.Reference(My_Set_1,
                   Position => My_Cursor_1).Element.all,
            Expected => Value_In_Array (1)+0.125,
