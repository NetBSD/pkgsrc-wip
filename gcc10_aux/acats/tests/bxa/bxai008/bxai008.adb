...
--      using the Ada 2012 index notation for Bounded_Ordered_Sets. We also
--      check that function Reference is not defined. We check this as it is
--      different than most of the other containers.
--
-- CHANGE HISTORY:
--      20 Nov 14   RLB     Created from parts of CXAI030.
...
begin
   ...
   declare
      ...
      My_Reference : My_Bounded_Ordered_Sets.Reference_Type :=
                              My_Set_1.Reference
   ...
   begin
      ...
      Test_and_Mod (
            Value    =>
               My_Bounded_Ordered_Sets.Reference(My_Set_1,
                   Position => My_Cursor_1).Element.all,
            Expected => Value_In_Array (1)+0.125,
