...
--      using the Ada 2012 index notation for Indefinite_Hashed_Sets. We also
...
begin
   ...
   declare
      ...
      My_Reference : My_Indefinite_Hashed_Sets.Reference_Type :=
                              My_Set_1.Reference
   ...
   begin
      ...
      Test_and_Mod (
            Value    =>
               My_Indefinite_Hashed_Sets.Reference(My_Set_1,
                   Position => My_Cursor_1).Element.all,
            Expected => "0A",
            New_Item => "06",
