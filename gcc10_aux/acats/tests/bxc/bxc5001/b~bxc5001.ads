...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_bxc5001" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c9177f5c#;
   pragma Export (C, u00001, "bxc5001B");
   ...
   u00168 : constant Version_32 := 16#ff2a7423#;
