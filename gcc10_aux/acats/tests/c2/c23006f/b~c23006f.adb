pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c23006f.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c23006f.adb");
...
package body ada_main is
   ...
   E006 : Short_Integer; pragma Import (Ada, E006, "c23006finst_E");
   ...
   begin
      ...
      Report'Elab_Body;
      E008 := E008 + 1;
      C23006FINST'ELAB_SPEC;
      E006 := E006 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c23006f");
