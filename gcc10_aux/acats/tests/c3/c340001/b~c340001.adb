pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c340001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c340001.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c340001_0_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "c340001_1_E");
   E117 : Short_Integer; pragma Import (Ada, E117, "c340001_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c340001_2__finalize_spec");
      begin
         F1;
      end;
      E115 := E115 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c340001_1__finalize_spec");
      begin
         F2;
      end;
      E107 := E107 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c340001_0__finalize_spec");
      begin
         F3;
      end;
      E121 := E121 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c340001");
