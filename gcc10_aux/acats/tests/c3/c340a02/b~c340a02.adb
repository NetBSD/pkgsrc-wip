pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c340a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c340a02.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "f340a001_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c340a02_0_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "c340a02_1_E");
   E112 : Short_Integer; pragma Import (Ada, E112, "c340a02_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c340a02_0__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f340a001__finalize_spec");
      begin
         F2;
      end;
      E122 := E122 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c340a02");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f340a000.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f340a001.o
   --   ./c340a02_0.o
   --   ./c340a02_1.o
   --   ./c340a02_2.o
