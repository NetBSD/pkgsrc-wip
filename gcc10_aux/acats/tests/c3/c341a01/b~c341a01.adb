pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c341a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c341a01.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "f341a00_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "f341a00_1_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "f341a00_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f341a00_2__finalize_spec");
      begin
         F1;
      end;
      E109 := E109 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f341a00_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f341a00_0__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c341a01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f341a00_0.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f341a00_1.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f341a00_2.o
