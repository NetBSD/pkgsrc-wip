pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c341a03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c341a03.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "f341a00_0_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c341a03_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "f341a00_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f341a00_1__finalize_spec");
      begin
         F1;
      end;
      E105 := E105 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f341a00_0__finalize_spec");
      begin
         F2;
      end;
      E135 := E135 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c341a03");
