...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c35102a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f1316912#;
   pragma Export (C, u00001, "c35102aB");
   ...
   u00174 : constant Version_32 := 16#655cb48e#;
   pragma Export (C, u00174, "system__val_enumB");
   u00175 : constant Version_32 := 16#c456f9ec#;
