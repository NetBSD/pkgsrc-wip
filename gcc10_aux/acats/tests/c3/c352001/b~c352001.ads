...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c352001" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#729b8ef2#;
   pragma Export (C, u00001, "c352001B");
   ...
   u00121 : constant Version_32 := 16#3a634af0#;
   pragma Export (C, u00121, "system__img_charS");
   u00122 : constant Version_32 := 16#bd8f82dc#;
   pragma Export (C, u00122, "system__img_wcharB");
   u00123 : constant Version_32 := 16#540470ba#;
   pragma Export (C, u00123, "system__img_wcharS");
   u00124 : constant Version_32 := 16#faa7f7a2#;
   pragma Export (C, u00124, "system__val_charB");
   u00125 : constant Version_32 := 16#1780eae6#;
   pragma Export (C, u00125, "system__val_charS");
   u00126 : constant Version_32 := 16#9040437a#;
   pragma Export (C, u00126, "system__val_wcharB");
   u00127 : constant Version_32 := 16#7f4e2e3e#;
   pragma Export (C, u00127, "system__val_wcharS");
   u00128 : constant Version_32 := 16#1593dca4#;
   pragma Export (C, u00128, "system__wch_wtsB");
   u00129 : constant Version_32 := 16#0e431f77#;
   pragma Export (C, u00129, "system__wch_wtsS");
