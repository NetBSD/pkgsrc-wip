...
BEGIN
     ...
     BEGIN
          IF INT'VALUE (IDENT_STR("-9223372036854775808")) /= MIN_INT THEN
     ...
     BEGIN
           IF INT'IMAGE (IDENT(MIN_INT)) /= "-9223372036854775808" THEN
     ...
     BEGIN
           IF INT'VALUE (IDENT_STR("9223372036854775807")) /= MAX_INT THEN
     ...
     BEGIN
           IF INT'IMAGE (IDENT(MAX_INT)) /= ' ' & "9223372036854775807" THEN
