...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c35a05n" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7792235d#;
   pragma Export (C, u00001, "c35a05nB");
   ...
   u00120 : constant Version_32 := 16#73127a31#;
   pragma Export (C, u00120, "system__foreB");
   u00121 : constant Version_32 := 16#3e77989f#;
   pragma Export (C, u00121, "system__foreS");
