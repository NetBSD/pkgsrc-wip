pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c380004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c380004.adb");
...
package body ada_main is
   ...
   begin
      ...
      System.Restrictions.Run_Time_Restrictions :=
        (Set =>
         ...
         Unknown => (False, False, False, True, False, True, True, False, True, False));
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c380004");
