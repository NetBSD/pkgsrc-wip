pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3900011.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3900011.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c3900010_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3900010__finalize_spec");
      begin
         F1;
      end;
      E115 := E115 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3900011");
