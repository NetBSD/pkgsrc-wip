pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390003.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390003.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c390003_1_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "c390003_2_E");
   E127 : Short_Integer; pragma Import (Ada, E127, "c390003_3_E");
   E129 : Short_Integer; pragma Import (Ada, E129, "c390003_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390003_4__finalize_spec");
      begin
         F1;
      end;
      E127 := E127 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c390003_3__finalize_spec");
      begin
         F2;
      end;
      E125 := E125 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c390003_2__finalize_spec");
      begin
         F3;
      end;
      E103 := E103 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c390003_1__finalize_spec");
      begin
         F4;
      end;
      E111 := E111 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c390003");
