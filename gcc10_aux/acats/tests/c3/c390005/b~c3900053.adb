pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3900053.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3900053.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c3900050_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "c3900051_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "c3900052_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3900052__finalize_spec");
      begin
         F1;
      end;
      E113 := E113 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c3900051__finalize_spec");
      begin
         F2;
      end;
      E005 := E005 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c3900050__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3900053");
