pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390007.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390007.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c390007_0_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "c390007_0__c390007_1_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c390007_0__c390007_1__c390007_2_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "c390007_0__c390007_3_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "c390007_0__c390007_3__c390007_4_E");
   E117 : Short_Integer; pragma Import (Ada, E117, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390007_0__c390007_3__c390007_4__finalize_spec");
      begin
         F1;
      end;
      E113 := E113 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c390007_0__c390007_3__finalize_spec");
      begin
         F2;
      end;
      E111 := E111 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c390007_0__c390007_1__c390007_2__finalize_spec");
      begin
         F3;
      end;
      E107 := E107 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c390007_0__c390007_1__finalize_spec");
      begin
         F4;
      end;
      E123 := E123 - 1;
   ...
   begin
      ...
      C390007_0'Elab_Spec;
      E103 := E103 + 1;
      C390007_0.C390007_1'Elab_Spec;
      C390007_0.C390007_1'Elab_Body;
      E107 := E107 + 1;
      C390007_0.C390007_1.C390007_2'Elab_Spec;
      C390007_0.C390007_1.C390007_2'Elab_Body;
      E111 := E111 + 1;
      C390007_0.C390007_3'Elab_Spec;
      C390007_0.C390007_3'Elab_Body;
      E113 := E113 + 1;
      C390007_0.C390007_3.C390007_4'Elab_Spec;
      C390007_0.C390007_3.C390007_4'Elab_Body;
      E115 := E115 + 1;
      Report'Elab_Body;
      E117 := E117 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c390007");
...
--  BEGIN Object file/option list
   --   ./c390007_0.o
   --   ./c390007_0-c390007_1.o
   --   ./c390007_0-c390007_1-c390007_2.o
   --   ./c390007_0-c390007_3.o
   --   ./c390007_0-c390007_3-c390007_4.o
