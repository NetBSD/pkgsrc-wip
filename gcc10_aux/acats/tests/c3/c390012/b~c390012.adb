pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390012.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390012.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "c390012_geometry_E");
   E153 : Short_Integer; pragma Import (Ada, E153, "report_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "impdef_E");
   E123 : Short_Integer; pragma Import (Ada, E123, "tctouch_E");
   E121 : Short_Integer; pragma Import (Ada, E121, "c390012_manager_E");
   E119 : Short_Integer; pragma Import (Ada, E119, "c390012_geometry__circles_E");
   E159 : Short_Integer; pragma Import (Ada, E159, "c390012_geometry__ghosts_E");
   E161 : Short_Integer; pragma Import (Ada, E161, "c390012_geometry__squares_E");
   E163 : Short_Integer; pragma Import (Ada, E163, "c390012_geometry__triangles_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390012_geometry__triangles__finalize_spec");
      begin
         F1;
      end;
      E161 := E161 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c390012_geometry__squares__finalize_spec");
      begin
         F2;
      end;
      E119 := E119 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c390012_geometry__circles__finalize_spec");
      begin
         F3;
      end;
      E121 := E121 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c390012_manager__finalize_spec");
      begin
         F4;
      end;
      E171 := E171 - 1;
   ...
   begin
      ...
      E171 := E171 + 1;
      C390012_Geometry'Elab_Spec;
      C390012_Geometry'Elab_Body;
      E105 := E105 + 1;
      Report'Elab_Body;
      E153 := E153 + 1;
      E125 := E125 + 1;
      E123 := E123 + 1;
      C390012_Manager'Elab_Spec;
      C390012_Manager'Elab_Body;
      E121 := E121 + 1;
      C390012_Geometry.Circles'Elab_Spec;
      C390012_Geometry.Circles'Elab_Body;
      E119 := E119 + 1;
      C390012_Geometry.Ghosts'Elab_Spec;
      C390012_Geometry.Ghosts'Elab_Body;
      E159 := E159 + 1;
      C390012_Geometry.Squares'Elab_Spec;
      C390012_Geometry.Squares'Elab_Body;
      E161 := E161 + 1;
      C390012_Geometry.Triangles'Elab_Spec;
      C390012_Geometry.Triangles'Elab_Body;
      E163 := E163 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c390012");
...
--  BEGIN Object file/option list
   ...
   --   ./c390012_manager.o
   --   ./c390012_geometry-circles.o
   --   ./c390012_geometry-ghosts.o
   --   ./c390012_geometry-squares.o
   --   ./c390012_geometry-triangles.o
   --   ./c390012.o
   --   -L./
