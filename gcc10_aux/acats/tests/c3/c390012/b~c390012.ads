...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c390012" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#201e8c22#;
   pragma Export (C, u00001, "c390012B");
   ...
   u00104 : constant Version_32 := 16#f8608908#;
   pragma Export (C, u00104, "c390012_geometryB");
   u00105 : constant Version_32 := 16#a57b3bfc#;
   pragma Export (C, u00105, "c390012_geometryS");
   ...
   u00111 : constant Version_32 := 16#a2c0a9e4#;
   pragma Export (C, u00111, "system__fat_llfS");
   u00112 : constant Version_32 := 16#cb3fb516#;
   ...
   u00114 : constant Version_32 := 16#1a29a9cb#;
   pragma Export (C, u00114, "system__exn_llfS");
   u00115 : constant Version_32 := 16#fe220e03#;
   ...
   u00118 : constant Version_32 := 16#f02a0e82#;
   pragma Export (C, u00118, "c390012_geometry__circlesB");
   u00119 : constant Version_32 := 16#2277599a#;
   pragma Export (C, u00119, "c390012_geometry__circlesS");
   u00120 : constant Version_32 := 16#bd1ed5d9#;
   pragma Export (C, u00120, "c390012_managerB");
   u00121 : constant Version_32 := 16#bbfdf892#;
   pragma Export (C, u00121, "c390012_managerS");
   u00122 : constant Version_32 := 16#2b11f710#;
   pragma Export (C, u00122, "tctouchB");
   u00123 : constant Version_32 := 16#2d42de40#;
   pragma Export (C, u00123, "tctouchS");
   u00124 : constant Version_32 := 16#74d3cdd6#;
   pragma Export (C, u00124, "impdefB");
   u00125 : constant Version_32 := 16#ba6af773#;
   pragma Export (C, u00125, "impdefS");
   u00126 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00126, "ada__text_ioB");
   u00127 : constant Version_32 := 16#971fad3a#;
   ...
   u00130 : constant Version_32 := 16#ec9c64c3#;
   pragma Export (C, u00130, "system__file_ioB");
   u00131 : constant Version_32 := 16#0126f372#;
   ...
   u00134 : constant Version_32 := 16#e9a56187#;
   pragma Export (C, u00134, "system__finalization_rootS");
   u00135 : constant Version_32 := 16#5bc888bf#;
   pragma Export (C, u00135, "system__file_control_blockS");
   u00136 : constant Version_32 := 16#91d53f4f#;
   pragma Export (C, u00136, "ada__text_io__modular_auxB");
   u00137 : constant Version_32 := 16#9bb2cffe#;
   pragma Export (C, u00137, "ada__text_io__modular_auxS");
   ...
   u00141 : constant Version_32 := 16#54f3e6d9#;
   pragma Export (C, u00141, "system__img_biuS");
   u00142 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00142, "system__img_llbB");
   u00143 : constant Version_32 := 16#1534f627#;
   pragma Export (C, u00143, "system__img_llbS");
   u00144 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00144, "system__img_lluB");
   u00145 : constant Version_32 := 16#db186e57#;
   pragma Export (C, u00145, "system__img_lluS");
   u00146 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00146, "system__img_llwB");
   u00147 : constant Version_32 := 16#bc58d5b1#;
   pragma Export (C, u00147, "system__img_llwS");
   u00148 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00148, "system__img_wiuB");
   u00149 : constant Version_32 := 16#3ab2614b#;
   pragma Export (C, u00149, "system__img_wiuS");
   u00150 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00150, "system__val_unsB");
   u00151 : constant Version_32 := 16#a7d7132d#;
   pragma Export (C, u00151, "system__val_unsS");
   u00152 : constant Version_32 := 16#92f3335b#;
   pragma Export (C, u00152, "reportB");
   u00153 : constant Version_32 := 16#df19fbea#;
   pragma Export (C, u00153, "reportS");
   u00154 : constant Version_32 := 16#fc54e290#;
   pragma Export (C, u00154, "ada__calendarB");
   u00155 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00155, "ada__calendarS");
   u00156 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00156, "system__os_primitivesB");
   u00157 : constant Version_32 := 16#a1aa77e1#;
   pragma Export (C, u00157, "system__os_primitivesS");
   u00158 : constant Version_32 := 16#001ce29b#;
   pragma Export (C, u00158, "c390012_geometry__ghostsB");
   u00159 : constant Version_32 := 16#54f314ba#;
   pragma Export (C, u00159, "c390012_geometry__ghostsS");
   u00160 : constant Version_32 := 16#feaf19ed#;
   pragma Export (C, u00160, "c390012_geometry__squaresB");
   u00161 : constant Version_32 := 16#6f486711#;
   pragma Export (C, u00161, "c390012_geometry__squaresS");
   u00162 : constant Version_32 := 16#cc54056a#;
   pragma Export (C, u00162, "c390012_geometry__trianglesB");
   u00163 : constant Version_32 := 16#a79b39cc#;
   pragma Export (C, u00163, "c390012_geometry__trianglesS");
   u00164 : constant Version_32 := 16#57674f80#;
   pragma Export (C, u00164, "system__finalization_mastersB");
   u00165 : constant Version_32 := 16#fdab2bdd#;
   ...
   u00167 : constant Version_32 := 16#538e63fc#;
   ...
   u00169 : constant Version_32 := 16#85ba8cba#;
   ...
   u00174 : constant Version_32 := 16#a02f73f2#;
   ...
   --  c390012_manager%s
   --  c390012_manager%b
   --  c390012_geometry.circles%s
   --  c390012_geometry.circles%b
   --  c390012_geometry.ghosts%s
   --  c390012_geometry.ghosts%b
   --  c390012_geometry.squares%s
   --  c390012_geometry.squares%b
   --  c390012_geometry.triangles%s
   --  c390012_geometry.triangles%b
   --  c390012%b
