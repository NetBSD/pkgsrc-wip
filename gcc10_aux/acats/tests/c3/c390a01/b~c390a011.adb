pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390a011.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390a011.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c390a010_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390a010__finalize_spec");
      begin
         F1;
      end;
      E111 := E111 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f390a00__finalize_spec");
      begin
         F2;
      end;
      E117 := E117 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c390a011");
