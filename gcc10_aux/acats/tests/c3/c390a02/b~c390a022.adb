pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390a022.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390a022.adb");
...
package body ada_main is
   ...
   E111 : Short_Integer; pragma Import (Ada, E111, "f390a00_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "c390a020_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "c390a021_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390a021__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c390a020__finalize_spec");
      begin
         F2;
      end;
      E111 := E111 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f390a00__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c390a022");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f390a00.o
   --   ./c390a020.o
   --   ./c390a021.o
