pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c390a031.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c390a031.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "f390a00_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c390a030_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c390a030__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c390a031");
