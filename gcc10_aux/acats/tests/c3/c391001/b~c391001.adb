pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c391001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c391001.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c391001_1_E");
   E104 : Short_Integer; pragma Import (Ada, E104, "c391001_2_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "c391001_3_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c391001_3__finalize_spec");
      begin
         E105 := E105 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c391001_2__finalize_spec");
      begin
         E104 := E104 - 1;
         F2;
      end;
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "c391001_1__finalize_spec");
      begin
         F3;
      end;
      E113 := E113 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c391001");
