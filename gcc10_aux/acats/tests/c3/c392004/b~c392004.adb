pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392004.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c392004_1_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "c392004_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392004_2__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392004_1__finalize_spec");
      begin
         F2;
      end;
      E113 := E113 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392004");
