pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392005.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392005.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c392005_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c392005_0__c392005_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392005_0__c392005_1__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392005_0__finalize_spec");
      begin
         F2;
      end;
      E117 := E117 - 1;
   ...
   begin
      ...
      C392005_0'Elab_Body;
      E005 := E005 + 1;
      C392005_0.C392005_1'Elab_Spec;
      C392005_0.C392005_1'Elab_Body;
      E109 := E109 + 1;
      Report'Elab_Body;
      E111 := E111 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392005");
