pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392008.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392008.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c392008_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c392008_1_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c392008_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392008_2__finalize_spec");
      begin
         F1;
      end;
      E109 := E109 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392008_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c392008_0__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392008");
