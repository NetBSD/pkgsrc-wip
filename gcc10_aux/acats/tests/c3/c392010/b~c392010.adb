pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392010.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392010.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c392010_0_E");
   E145 : Short_Integer; pragma Import (Ada, E145, "c392010_1_E");
   E157 : Short_Integer; pragma Import (Ada, E157, "c392010_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392010_2__finalize_spec");
      begin
         F1;
      end;
      E145 := E145 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392010_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c392010_0__finalize_spec");
      begin
         F3;
      end;
      E153 := E153 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392010");
