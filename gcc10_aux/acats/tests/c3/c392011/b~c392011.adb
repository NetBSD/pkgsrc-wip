pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392011.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392011.adb");
...
package body ada_main is
   ...
   E145 : Short_Integer; pragma Import (Ada, E145, "c392011_0_E");
   E143 : Short_Integer; pragma Import (Ada, E143, "c392011_1_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c392011_2_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "c392011_2__c392011_3_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392011_2__c392011_3__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392011_2__finalize_spec");
      begin
         F2;
      end;
      E143 := E143 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c392011_1__finalize_spec");
      begin
         F3;
      end;
      E145 := E145 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c392011_0__finalize_spec");
      begin
         F4;
      end;
      E151 := E151 - 1;
   ...
   begin
      ...
      C392011_2'Elab_Body;
      E005 := E005 + 1;
      C392011_2.C392011_3'Elab_Spec;
      E149 := E149 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c392011");
