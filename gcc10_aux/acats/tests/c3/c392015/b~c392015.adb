pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392015.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392015.adb");
...
package body ada_main is
   ...
   E147 : Short_Integer; pragma Import (Ada, E147, "report_E");
   E122 : Short_Integer; pragma Import (Ada, E122, "impdef_E");
   E120 : Short_Integer; pragma Import (Ada, E120, "tctouch_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c392015_0_E");
   E153 : Short_Integer; pragma Import (Ada, E153, "c392015_1_E");
   E155 : Short_Integer; pragma Import (Ada, E155, "c392015_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392015_2__finalize_spec");
      begin
         F1;
      end;
      E153 := E153 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392015_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c392015_0__finalize_spec");
      begin
         F3;
      end;
      E124 := E124 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392015");
