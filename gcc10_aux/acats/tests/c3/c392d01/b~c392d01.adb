pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392d01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392d01.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "f392d00_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c392d01_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c392d01_0__c392d01_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392d01_0__c392d01_1__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c392d01_0__finalize_spec");
      begin
         F2;
      end;
      E107 := E107 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f392d00__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   begin
      ...
      C392D01_0'ELAB_BODY;
      E005 := E005 + 1;
      C392D01_0.C392D01_1'ELAB_SPEC;
      C392D01_0.C392D01_1'ELAB_BODY;
      E111 := E111 + 1;
      Report'Elab_Body;
      E113 := E113 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392d01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f392d00.o
   --   ./c392d01_0.o
   --   ./c392d01_0-c392d01_1.o
