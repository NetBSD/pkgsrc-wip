pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c392d03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c392d03.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c392d03_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c392d03_0__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f392d00__finalize_spec");
      begin
         F2;
      end;
      E117 := E117 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c392d03");
