pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393001.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c393001_1_E");
   E145 : Short_Integer; pragma Import (Ada, E145, "c393001_2_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "c393001_3_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "c393001_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c393001_4__finalize_spec");
      begin
         F1;
      end;
      E147 := E147 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c393001_3__finalize_spec");
      begin
         F2;
      end;
      E145 := E145 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c393001_2__finalize_spec");
      begin
         F3;
      end;
      E109 := E109 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393001");
