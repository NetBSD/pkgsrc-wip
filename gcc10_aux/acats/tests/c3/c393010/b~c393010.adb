pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393010.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393010.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c393010_0_E");
   E145 : Short_Integer; pragma Import (Ada, E145, "c393010_1_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "c393010_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c393010_2__finalize_spec");
      begin
         F1;
      end;
      E145 := E145 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c393010_1__finalize_spec");
      begin
         F2;
      end;
      E157 := E157 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393010");
