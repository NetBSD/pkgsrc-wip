pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393011.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393011.adb");
...
package body ada_main is
   ...
   E108 : Short_Integer; pragma Import (Ada, E108, "c393011_1_E");
   E006 : Short_Integer; pragma Import (Ada, E006, "c393011_3_E");
   E117 : Short_Integer; pragma Import (Ada, E117, "c393011_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c393011_4__finalize_spec");
      begin
         F1;
      end;
      E121 := E121 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393011");
