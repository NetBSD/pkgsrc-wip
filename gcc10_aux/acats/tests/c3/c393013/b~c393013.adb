pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393013.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393013.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c393013_1_E");
   E108 : Short_Integer; pragma Import (Ada, E108, "c393013_2_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c393013_3_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c393013_4_E");
   E112 : Short_Integer; pragma Import (Ada, E112, "c393013_5_E");
   E116 : Short_Integer; pragma Import (Ada, E116, "report_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c393013_5__finalize_spec");
      begin
         E112 := E112 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "c393013_4__finalize_spec");
      begin
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c393013_3__finalize_spec");
      begin
         E109 := E109 - 1;
         F3;
      end;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c393013_2__finalize_spec");
      begin
         E108 := E108 - 1;
         F4;
      end;
      ...
      declare
         procedure F5;
         pragma Import (Ada, F5, "c393013_1__finalize_spec");
      begin
         F5;
      end;
      E122 := E122 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393013");
