pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393a02.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "f393a00_0_E");
   E123 : Short_Integer; pragma Import (Ada, E123, "f393a00_1_E");
   E127 : Short_Integer; pragma Import (Ada, E127, "f393a00_2_E");
   E129 : Short_Integer; pragma Import (Ada, E129, "f393a00_3_E");
   E131 : Short_Integer; pragma Import (Ada, E131, "f393a00_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f393a00_4__finalize_spec");
      begin
         F1;
      end;
      E129 := E129 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f393a00_3__finalize_spec");
      begin
         F2;
      end;
      E127 := E127 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f393a00_2__finalize_spec");
      begin
         F3;
      end;
      E111 := E111 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393a02");
