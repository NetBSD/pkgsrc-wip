pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393a05.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393a05.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "report_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "f393a00_0_E");
   E129 : Short_Integer; pragma Import (Ada, E129, "f393a00_1_E");
   E127 : Short_Integer; pragma Import (Ada, E127, "f393a00_2_E");
   E133 : Short_Integer; pragma Import (Ada, E133, "f393a00_3_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "f393a00_4_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c393a05_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c393a05_0__finalize_spec");
      begin
         F1;
      end;
      E125 := E125 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f393a00_4__finalize_spec");
      begin
         F2;
      end;
      E133 := E133 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f393a00_3__finalize_spec");
      begin
         F3;
      end;
      E127 := E127 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "f393a00_2__finalize_spec");
      begin
         F4;
      end;
      E113 := E113 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393a05");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393a00_0.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393a00_1.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393a00_2.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393a00_3.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393a00_4.o
   --   ./c393a05_0.o
   --   ./c393a05.o
   --   -L./
