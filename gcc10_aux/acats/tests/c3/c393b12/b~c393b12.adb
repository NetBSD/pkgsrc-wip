pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393b12.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393b12.adb");
...
package body ada_main is
   ...
   E110 : Short_Integer; pragma Import (Ada, E110, "f393b00_E");
   E108 : Short_Integer; pragma Import (Ada, E108, "c393b12_0_E");
   E006 : Short_Integer; pragma Import (Ada, E006, "c393b12_1__c393b12_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f393b00__finalize_spec");
      begin
         F1;
      end;
      E120 := E120 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393b12");
