pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393b13.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393b13.adb");
...
package body ada_main is
   ...
   E109 : Short_Integer; pragma Import (Ada, E109, "f393b00__c393b13_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f393b00__c393b13_0__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
   ...
   begin
      ...
      F393B00'ELAB_BODY;
      E005 := E005 + 1;
      F393B00.C393B13_0'ELAB_SPEC;
      F393B00.C393B13_0'ELAB_BODY;
      E109 := E109 + 1;
      Report'Elab_Body;
      E113 := E113 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393b13");
