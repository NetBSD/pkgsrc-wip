pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c393b14.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c393b14.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "f393b00_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "f393b00__c393b14_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "f393b00__c393b14_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f393b00__c393b14_0__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f393b00__finalize_spec");
      begin
         F2;
      end;
      E119 := E119 - 1;
   ...
   begin
      ...
      F393B00'ELAB_BODY;
      E005 := E005 + 1;
      F393B00.C393B14_0'ELAB_SPEC;
      F393B00.C393B14_0'ELAB_BODY;
      E111 := E111 + 1;
      E109 := E109 + 1;
      Report'Elab_Body;
      E113 := E113 + 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c393b14");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f393b00.o
   --   ./f393b00-c393b14_0.o
   --   ./f393b00-c393b14_1.o
