pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a0007.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a0007.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c3a0007_0_E");
   E145 : Short_Integer; pragma Import (Ada, E145, "c3a0007_1_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "c3a0007_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a0007_1__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c3a0007_0__finalize_spec");
      begin
         F2;
      end;
      E109 := E109 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a0007");
