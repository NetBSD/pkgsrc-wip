pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a0013.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a0013.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "c3a0013_1_E");
   E135 : Short_Integer; pragma Import (Ada, E135, "c3a0013_2_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "c3a0013_3_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c3a0013_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a0013_3__finalize_spec");
      begin
         F1;
      end;
      E135 := E135 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c3a0013_2__finalize_spec");
      begin
         F2;
      end;
      E105 := E105 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c3a0013_1__finalize_spec");
      begin
         F3;
      end;
      E131 := E131 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a0013");
