pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a0015.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a0015.adb");
...
package body ada_main is
   ...
   E129 : Short_Integer; pragma Import (Ada, E129, "system__pool_size_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c3a0015_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a0015_0__finalize_spec");
      begin
         F1;
      end;
      E129 := E129 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "system__pool_size__finalize_spec");
      begin
         F2;
      end;
      E125 := E125 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a0015");
