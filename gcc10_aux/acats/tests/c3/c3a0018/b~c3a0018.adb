pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a0018.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a0018.adb");
...
package body ada_main is
   ...
   E097 : Short_Integer; pragma Import (Ada, E097, "c3a0018p_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a0018p__finalize_spec");
      begin
         F1;
      end;
      E111 := E111 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a0018");
