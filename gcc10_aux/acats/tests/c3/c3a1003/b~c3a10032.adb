pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a10032.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a10032.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c3a1003d_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "c3a1003e_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c3a10030_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a1003e__finalize_spec");
      begin
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c3a1003d__finalize_spec");
      begin
         F2;
      end;
      E133 := E133 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a10032");
