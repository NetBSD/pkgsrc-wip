pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c3a2001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c3a2001.adb");
...
package body ada_main is
   ...
   E109 : Short_Integer; pragma Import (Ada, E109, "impdef_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "tctouch_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "c3a2001_1_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "c3a2001_2_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "c3a2001_3_E");
   E151 : Short_Integer; pragma Import (Ada, E151, "c3a2001_4_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c3a2001_5_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c3a2001_5__finalize_spec");
      begin
         F1;
      end;
      E151 := E151 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c3a2001_4__finalize_spec");
      begin
         F2;
      end;
      E149 := E149 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c3a2001_3__finalize_spec");
      begin
         F3;
      end;
      E147 := E147 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c3a2001_2__finalize_spec");
      begin
         F4;
      end;
      E153 := E153 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c3a2001");
