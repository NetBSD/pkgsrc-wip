pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c413004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c413004.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c413004p_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c413004q_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c413004q__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c413004p__finalize_spec");
      begin
         F2;
      end;
      E117 := E117 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c413004");
