...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c41325a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#add19b6f#;
   pragma Export (C, u00001, "c41325aB");
   ...
   u00120 : constant Version_32 := 16#9ef7df63#;
   pragma Export (C, u00120, "system__boolean_array_operationsS");
   u00121 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00121, "system__address_operationsB");
   u00122 : constant Version_32 := 16#b55bac24#;
   pragma Export (C, u00122, "system__address_operationsS");
   u00123 : constant Version_32 := 16#db92bda7#;
   pragma Export (C, u00123, "system__vectorsS");
   u00124 : constant Version_32 := 16#9fa5cd3a#;
   pragma Export (C, u00124, "system__vectors__boolean_operationsB");
   u00125 : constant Version_32 := 16#b42bd080#;
   pragma Export (C, u00125, "system__vectors__boolean_operationsS");
   u00126 : constant Version_32 := 16#047012d2#;
   pragma Export (C, u00126, "system__compare_array_signed_32B");
   u00127 : constant Version_32 := 16#dfbfda6a#;
   pragma Export (C, u00127, "system__compare_array_signed_32S");
