pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c416a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c416a01.adb");
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f416a00__finalize_spec");
      begin
         F1;
      end;
      E109 := E109 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c416a01");
