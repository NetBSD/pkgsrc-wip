pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c416a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c416a02.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "f416a00_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "f416a00__c416a02_a_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f416a00__c416a02_a__finalize_spec");
      begin
         F1;
      end;
      E103 := E103 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f416a00__finalize_spec");
      begin
         F2;
      end;
      E109 := E109 - 1;
   ...
   begin
      ...
      F416A00'ELAB_BODY;
      E103 := E103 + 1;
      F416A00.C416A02_A'ELAB_SPEC;
      F416A00.C416A02_A'ELAB_BODY;
      E147 := E147 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c416a02");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f416a00.o
   --   ./f416a00-c416a02_a.o
   --   ./c416a02.o
   --   -L./
