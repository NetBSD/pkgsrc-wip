pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c432001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c432001.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c432001_0_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "c432001_1_E");
   E127 : Short_Integer; pragma Import (Ada, E127, "c432001_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c432001_2__finalize_spec");
      begin
         F1;
      end;
      E125 := E125 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c432001_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c432001_0__finalize_spec");
      begin
         F3;
      end;
      E113 := E113 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c432001");
