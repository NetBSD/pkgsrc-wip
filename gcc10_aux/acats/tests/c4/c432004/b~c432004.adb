pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c432004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c432004.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c432004_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c432004_1_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "c432004_2_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c432004_2__finalize_spec");
      begin
         E110 := E110 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "c432004_1__finalize_spec");
      begin
         F2;
      end;
      E118 := E118 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c432004");
