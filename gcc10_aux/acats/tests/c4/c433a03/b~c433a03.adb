pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c433a03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c433a03.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "f433a00_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f433a00__finalize_spec");
      begin
         F1;
      end;
      E155 := E155 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c433a03");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f433a00.o
   --   ./c433a03.o
   --   -L./
