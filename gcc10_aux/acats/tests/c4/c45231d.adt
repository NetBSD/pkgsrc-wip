...
PROCEDURE C45231D IS
     ...
     FUNCTION IDENT (X : LONG_LONG_INTEGER)
          RETURN LONG_LONG_INTEGER IS   -- N/A => ERROR.
     BEGIN
          RETURN LONG_LONG_INTEGER (IDENT_INT (INTEGER (X)));
     END IDENT;
...
BEGIN
     ...
     TEST ( "C45231D", "CHECK THAT THE RELATIONAL AND " &
                       ...
                       "RESULTS FOR PREDEFINED TYPE LONG_LONG_INTEGER " &
                       "(INCLUDING THE CASE IN WHICH THE " &
                       "RELATIONAL OPERATORS ARE REDEFINED)" );

     DECLARE -- (A)

          I1A, I1B   : LONG_LONG_INTEGER          := IDENT (1);
          I2         : LONG_LONG_INTEGER          := IDENT (2);
          CI2        : CONSTANT LONG_LONG_INTEGER := 2;
     ...
     DECLARE -- (B)
          ...
          SUBTYPE ST IS LONG_LONG_INTEGER RANGE -10 .. 10;

          I1 : LONG_LONG_INTEGER := IDENT (1);
          I5 : LONG_LONG_INTEGER := IDENT (5);

          CI2  : CONSTANT LONG_LONG_INTEGER := 2;
          CI10 : CONSTANT LONG_LONG_INTEGER := 10;
     ...
     DECLARE -- (C)
          ...
          FUNCTION ">" ( L, R : LONG_LONG_INTEGER ) RETURN BOOLEAN IS
          BEGIN
               RETURN LONG_LONG_INTEGER'POS (L) <= 
	              LONG_LONG_INTEGER'POS (R);
          END;
