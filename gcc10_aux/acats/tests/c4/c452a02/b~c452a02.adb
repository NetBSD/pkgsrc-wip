pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c452a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c452a02.adb");
...
package body ada_main is
   ...
   E136 : Short_Integer; pragma Import (Ada, E136, "ada__strings__wide_maps_E");
   E144 : Short_Integer; pragma Import (Ada, E144, "ada__strings__wide_unbounded_E");
   E148 : Short_Integer; pragma Import (Ada, E148, "ada__strings__wide_wide_maps_E");
   E156 : Short_Integer; pragma Import (Ada, E156, "ada__strings__wide_wide_unbounded_E");
   E162 : Short_Integer; pragma Import (Ada, E162, "ada__calendar_E");
   E166 : Short_Integer; pragma Import (Ada, E166, "ada__text_io_E");
   E160 : Short_Integer; pragma Import (Ada, E160, "report_E");
   E158 : Short_Integer; pragma Import (Ada, E158, "f452a00_E");
   ...
   begin
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "ada__strings__wide_wide_unbounded__finalize_spec");
      begin
         F2;
      end;
      E148 := E148 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "ada__strings__wide_wide_maps__finalize_spec");
      begin
         F3;
      end;
      E144 := E144 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "ada__strings__wide_unbounded__finalize_spec");
      begin
         F4;
      end;
      E136 := E136 - 1;
      declare
         procedure F5;
         pragma Import (Ada, F5, "ada__strings__wide_maps__finalize_spec");
      begin
         F5;
      end;
      E107 := E107 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c452a02");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f452a00.o
   --   ./c452a02.o
   --   -L./
