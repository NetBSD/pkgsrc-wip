pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c460006.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c460006.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "c460006_0_E");
   E108 : Short_Integer; pragma Import (Ada, E108, "c460006_0__c460006_1_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "c460006_0__c460006_1__c460006_2_E");
   E114 : Short_Integer; pragma Import (Ada, E114, "c460006_0__c460006_1__c460006_2__c460006_3_E");
   E129 : Short_Integer; pragma Import (Ada, E129, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c460006_0__c460006_1__c460006_2__c460006_3__finalize_spec");
      begin
         F1;
      end;
      E110 := E110 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c460006_0__c460006_1__c460006_2__finalize_spec");
      begin
         F2;
      end;
      E108 := E108 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c460006_0__c460006_1__finalize_spec");
      begin
         F3;
      end;
      E135 := E135 - 1;
   ...
   begin
      ...
      C460006_0'Elab_Spec;
      E102 := E102 + 1;
      C460006_0.C460006_1'Elab_Spec;
      C460006_0.C460006_1'Elab_Body;
      E108 := E108 + 1;
      C460006_0.C460006_1.C460006_2'Elab_Spec;
      C460006_0.C460006_1.C460006_2'Elab_Body;
      E110 := E110 + 1;
      C460006_0.C460006_1.C460006_2.C460006_3'Elab_Spec;
      C460006_0.C460006_1.C460006_2.C460006_3'Elab_Body;
      E114 := E114 + 1;
      Report'Elab_Body;
      E129 := E129 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c460006");
...
--  BEGIN Object file/option list
   --   ./c460006_0.o
   --   ./c460006_0-c460006_1.o
   --   ./c460006_0-c460006_1-c460006_2.o
   --   ./c460006_0-c460006_1-c460006_2-c460006_3.o
