pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c460014.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c460014.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c460014_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c460014_1__finalize_spec");
      begin
         F1;
      end;
      E129 := E129 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c460014");
