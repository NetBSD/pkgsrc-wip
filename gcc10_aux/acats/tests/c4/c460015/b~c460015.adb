pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c460015.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c460015.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c460015_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c460015_1__finalize_spec");
      begin
         F1;
      end;
      E161 := E161 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c460015");
