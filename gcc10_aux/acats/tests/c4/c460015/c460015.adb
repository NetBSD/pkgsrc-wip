...
procedure C460015 is

   My_Root_Facade_Ptr : constant C460015_1.Facade_Class_Ptr_Type :=
                                    C460015_1.Init_Facade_Class_Ptr_with_Root;

   My_Facade_A_Ptr    : constant C460015_1.Facade_Class_Ptr_Type :=
                                    C460015_1.Init_Facade_Class_Ptr_with_A;

   My_Facade_B_Ptr    : constant C460015_1.Facade_Class_Ptr_Type :=
                                    C460015_1.Init_Facade_Class_Ptr_with_B;

   My_Null_Facade_B_Ptr    : constant C460015_1.Facade_B_Ptr_Type := null;

   Constraint_Error_Raised : Boolean;

   procedure Test_Define_Construct
    (Facade_Class_Ptr : in C460015_1.Facade_Class_Ptr_Type) is
   begin
      ...
      -- or Facade_B_Type.
      C460015_1.Define_Construct (Facade_Class_Ptr => Facade_Class_Ptr);
   exception
   ...
   begin
      ...
      -- parameter doesn't designate an object of Facade_A_Type
      -- or Facade_B_Type.
      C460015_1.Define_Class_Construct (Facade_Class_Ptr => Facade_Class_Ptr);
   exception
      when Constraint_Error =>
         Constraint_Error_Raised := True;
...
begin
   ...
   Report.Test
     ("C460015",
      ...
      "access-to-limited-class-wide, Constraint_Error is raised if the tag " &
      "of the object designated by the operand does not identify a specific " &
      "type that is covered by or descended from the target type");
   ...
   Test_Define_Class_Construct (Facade_Class_Ptr =>
      C460015_1.Facade_Class_Ptr_Type (My_Null_Facade_B_Ptr));
