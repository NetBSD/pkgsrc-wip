...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c52104x" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9f4ca683#;
   pragma Export (C, u00001, "c52104xB");
   ...
   u00120 : constant Version_32 := 16#f3e24385#;
   pragma Export (C, u00120, "system__bitfieldsS");
   u00121 : constant Version_32 := 16#3711e420#;
   pragma Export (C, u00121, "system__bitfield_utilsB");
   u00122 : constant Version_32 := 16#cc159f29#;
   pragma Export (C, u00122, "system__bitfield_utilsS");
   ...
   --  system.wch_cnv%s
   --  system.wch_cnv%b
   --  system.bitfield_utils%s
   --  system.bitfield_utils%b
   --  system.bitfields%s
   --  system.traceback%s
   --  system.traceback%b
