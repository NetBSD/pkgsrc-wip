pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c552a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c552a02.adb");
...
package body ada_main is
   ...
   E130 : Short_Integer; pragma Import (Ada, E130, "f552a00_bingo_balls_E");
   E146 : Short_Integer; pragma Import (Ada, E146, "f552a00_sparse_arrays_E");
   E148 : Short_Integer; pragma Import (Ada, E148, "report_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "f552a00_bingo_balls__finalize_body");
      begin
         E130 := E130 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f552a00_bingo_balls__finalize_spec");
      begin
         F2;
      end;
      E150 := E150 - 1;
   ...
   begin
      ...
      E137 := E137 + 1;
      F552a00_Bingo_Balls'Elab_Spec;
      F552a00_Bingo_Balls'Elab_Body;
      E130 := E130 + 1;
      E146 := E146 + 1;
      Report'Elab_Body;
      E148 := E148 + 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c552a02");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f552a00_bingo_balls.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f552a00_sparse_arrays.o
