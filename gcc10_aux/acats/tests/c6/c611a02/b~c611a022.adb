pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c611a022.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c611a022.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c611a020_E");
   E143 : Short_Integer; pragma Import (Ada, E143, "c611a020__child_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c611a020__child__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c611a020__finalize_spec");
      begin
         F2;
      end;
      E125 := E125 - 1;
   ...
   begin
      ...
      C611A020'ELAB_BODY;
      E107 := E107 + 1;
      C611A020.CHILD'ELAB_SPEC;
      C611A020.CHILD'ELAB_BODY;
      E143 := E143 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c611a022");
