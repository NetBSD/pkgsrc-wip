pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c611a032.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c611a032.adb");
...
package body ada_main is
   ...
   E137 : Short_Integer; pragma Import (Ada, E137, "f611a00_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "c611a030_E");
   E143 : Short_Integer; pragma Import (Ada, E143, "c611a030__child_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c611a030__child__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c611a030__finalize_spec");
      begin
         F2;
      end;
      E125 := E125 - 1;
   ...
   begin
      ...
      C611A030'ELAB_BODY;
      E107 := E107 + 1;
      C611A030.CHILD'ELAB_SPEC;
      C611A030.CHILD'ELAB_BODY;
      E143 := E143 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c611a032");
