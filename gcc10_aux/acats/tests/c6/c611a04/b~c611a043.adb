pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c611a043.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c611a043.adb");
...
package body ada_main is
   ...
   E112 : Short_Integer; pragma Import (Ada, E112, "report_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "f611a00_E");
   E106 : Short_Integer; pragma Import (Ada, E106, "c611a040_E");
   E130 : Short_Integer; pragma Import (Ada, E130, "c611a040__child_E");
   E144 : Short_Integer; pragma Import (Ada, E144, "c611a040__child__grandchild_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c611a040__child__grandchild__finalize_spec");
      begin
         F1;
      end;
      E130 := E130 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c611a040__child__finalize_spec");
      begin
         F2;
      end;
      E118 := E118 - 1;
   ...
   begin
      ...
      C611A040'ELAB_SPEC;
      E106 := E106 + 1;
      C611A040.CHILD'ELAB_SPEC;
      C611A040.CHILD'ELAB_BODY;
      E130 := E130 + 1;
      C611A040.CHILD.GRANDCHILD'ELAB_SPEC;
      C611A040.CHILD.GRANDCHILD'ELAB_BODY;
      E144 := E144 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c611a043");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f611a00.o
   --   ./c611a040.o
   --   ./c611a040-child.o
   --   ./c611a040-child-grandchild.o
   --   ./c611a043.o
   --   -L./
