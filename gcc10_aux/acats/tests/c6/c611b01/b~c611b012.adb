pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c611b012.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c611b012.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "f611b00_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c611b010_E");
   E131 : Short_Integer; pragma Import (Ada, E131, "c611b010__child_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c611b010__child__finalize_spec");
      begin
         F1;
      end;
      E103 := E103 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c611b010__finalize_spec");
      begin
         F2;
      end;
      E113 := E113 - 1;
   ...
   begin
      ...
      C611B010'ELAB_BODY;
      E103 := E103 + 1;
      C611B010.CHILD'ELAB_SPEC;
      C611B010.CHILD'ELAB_BODY;
      E131 := E131 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c611b012");
