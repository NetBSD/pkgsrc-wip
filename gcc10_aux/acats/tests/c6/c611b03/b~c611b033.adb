pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c611b033.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c611b033.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "c611b030_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "report_E");
   E108 : Short_Integer; pragma Import (Ada, E108, "f611b00_E");
   E106 : Short_Integer; pragma Import (Ada, E106, "c611b030__child_E");
   E132 : Short_Integer; pragma Import (Ada, E132, "c611b030__child__grandchild_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c611b030__child__grandchild__finalize_spec");
      begin
         F1;
      end;
      E106 := E106 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c611b030__child__finalize_spec");
      begin
         F2;
      end;
      E116 := E116 - 1;
   ...
   begin
      ...
      E110 := E110 + 1;
      E108 := E108 + 1;
      C611B030.CHILD'ELAB_SPEC;
      C611B030.CHILD'ELAB_BODY;
      E106 := E106 + 1;
      C611B030.CHILD.GRANDCHILD'ELAB_SPEC;
      C611B030.CHILD.GRANDCHILD'ELAB_BODY;
      E132 := E132 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c611b033");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f611b00.o
   --   ./c611b030-child.o
   --   ./c611b030-child-grandchild.o
   --   ./c611b033.o
   --   -L./
