pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c650a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c650a01.adb");
...
package body ada_main is
   ...
   E104 : Short_Integer; pragma Import (Ada, E104, "f650a00_E");
   E106 : Short_Integer; pragma Import (Ada, E106, "f650a00__p_E");
   E121 : Short_Integer; pragma Import (Ada, E121, "c650a01_map_E");
   E119 : Short_Integer; pragma Import (Ada, E119, "f650a00__s_E");
   E102 : Short_Integer; pragma Import (Ada, E102, "c650a01_alerts_E");
   E151 : Short_Integer; pragma Import (Ada, E151, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f650a00__s__finalize_spec");
      begin
         F1;
      end;
      E106 := E106 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f650a00__p__finalize_spec");
      begin
         F2;
      end;
      E155 := E155 - 1;
   ...
   begin
      ...
      F650A00.P'ELAB_BODY;
      E106 := E106 + 1;
      C650a01_Map'Elab_Body;
      E121 := E121 + 1;
      F650A00.S'ELAB_SPEC;
      F650A00.S'ELAB_BODY;
      E119 := E119 + 1;
      C650a01_Alerts'Elab_Spec;
      E102 := E102 + 1;
      Report'Elab_Body;
      E151 := E151 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c650a01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650a00.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650a00-p.o
   --   ./c650a01_map.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650a00-s.o
   --   ./c650a01_alerts.o
