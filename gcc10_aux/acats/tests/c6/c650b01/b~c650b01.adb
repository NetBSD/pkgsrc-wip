pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c650b01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c650b01.adb");
...
package body ada_main is
   ...
   E143 : Short_Integer; pragma Import (Ada, E143, "f650b00_1_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "f650b00_2_E");
   E147 : Short_Integer; pragma Import (Ada, E147, "f650b00_3_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "f650b00_4_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f650b00_4__finalize_spec");
      begin
         F1;
      end;
      E147 := E147 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f650b00_3__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "f650b00_2__finalize_spec");
      begin
         F3;
      end;
      E157 := E157 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c650b01");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650b00_1.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650b00_2.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650b00_3.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f650b00_4.o
   --   ./c650b01.o
   --   -L./
