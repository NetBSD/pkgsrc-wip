pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c650b04.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c650b04.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "f650b00_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f650b00_3__finalize_spec");
      begin
         F1;
      end;
      E105 := E105 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f650b00_2__finalize_spec");
      begin
         F2;
      end;
      E155 := E155 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c650b04");
