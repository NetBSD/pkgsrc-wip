pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c660001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c660001.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "c660001_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c660001_0__finalize_spec");
      begin
         F1;
      end;
      E128 := E128 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c660001");
