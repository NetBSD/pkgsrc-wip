pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c730001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c730001.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c730001_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c730001_1_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c730001_2_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "c730001_3_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c730001_3__finalize_spec");
      begin
         F1;
      end;
      E111 := E111 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c730001_2__finalize_spec");
      begin
         F2;
      end;
      E109 := E109 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c730001_1__finalize_spec");
      begin
         F3;
      end;
      E103 := E103 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c730001_0__finalize_spec");
      begin
         F4;
      end;
      E121 := E121 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c730001");
