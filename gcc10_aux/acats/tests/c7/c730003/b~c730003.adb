pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c730003.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c730003.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c730003_0_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "c730003_1_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c730003_0__c730003_2_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c730003_0__c730003_2__finalize_spec");
      begin
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c730003_1__finalize_spec");
      begin
         E110 := E110 - 1;
         F2;
      end;
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "c730003_0__finalize_spec");
      begin
         F3;
      end;
      E120 := E120 - 1;
   ...
   begin
      ...
      C730003_1'Elab_Spec;
      E110 := E110 + 1;
      C730003_0.C730003_2'Elab_Spec;
      C730003_0.C730003_2'Elab_Body;
      E109 := E109 + 1;
      Report'Elab_Body;
      E114 := E114 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c730003");
