pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c730a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c730a01.adb");
...
package body ada_main is
   ...
   E104 : Short_Integer; pragma Import (Ada, E104, "f730a001_E");
   E102 : Short_Integer; pragma Import (Ada, E102, "c730a01_0_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "c730a01_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f730a001__finalize_spec");
      begin
         F1;
      end;
      E120 := E120 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c730a01");
