pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c731001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c731001.adb");
...
package body ada_main is
   ...
   E099 : Short_Integer; pragma Import (Ada, E099, "report_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "c731001_1__parent_E");
   E127 : Short_Integer; pragma Import (Ada, E127, "c731001_1__parent__main_E");
   E131 : Short_Integer; pragma Import (Ada, E131, "c731001_1__unrelated_E");
   E129 : Short_Integer; pragma Import (Ada, E129, "c731001_1__parent__child_E");
   E123 : Short_Integer; pragma Import (Ada, E123, "c731001_1__main_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c731001_1__parent__child__finalize_body");
      begin
         E129 := E129 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c731001_1__parent__child__finalize_spec");
      begin
         F2;
      end;
      E131 := E131 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c731001_1__unrelated__finalize_spec");
      begin
         F3;
      end;
      E125 := E125 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c731001_1__parent__finalize_spec");
      begin
         F4;
      end;
      E111 := E111 - 1;
   ...
   begin
      ...
      Report'Elab_Body;
      E099 := E099 + 1;
      C731001_1.Parent'Elab_Spec;
      C731001_1.Parent'Elab_Body;
      E125 := E125 + 1;
      C731001_1.Unrelated'Elab_Spec;
      C731001_1.Unrelated'Elab_Body;
      E131 := E131 + 1;
      C731001_1.Parent.Child'Elab_Spec;
      C731001_1.Parent.Child'Elab_Body;
      E129 := E129 + 1;
      E127 := E127 + 1;
      E123 := E123 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c731001");
...
--  BEGIN Object file/option list
   ...
   --   ./c731001_1.o
   --   ./c731001_1-parent.o
   --   ./c731001_1-unrelated.o
   --   ./c731001_1-parent-child.o
   --   ./c731001_1-parent-main.o
   --   ./c731001_1-main.o
   --   ./c731001.o
   --   -L./
