pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c7320012.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c7320012.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c7320010_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "report_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "c7320011_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c7320011__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c7320010__finalize_spec");
      begin
         F2;
      end;
      E121 := E121 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c7320012");
