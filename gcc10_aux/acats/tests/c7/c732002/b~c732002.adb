pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c732002.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c732002.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c732002_places_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "c732002_places__inner_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c732002_places__inner__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c732002_places__finalize_spec");
      begin
         F2;
      end;
      E121 := E121 - 1;
   ...
   begin
      ...
      E099 := E099 + 1;
      C732002_Places'Elab_Spec;
      C732002_Places'Elab_Body;
      E107 := E107 + 1;
      C732002_Places.Inner'Elab_Spec;
      C732002_Places.Inner'Elab_Body;
      E113 := E113 + 1;
      Report'Elab_Body;
      E115 := E115 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c732002");
