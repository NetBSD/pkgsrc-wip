pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c732c01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c732c01.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "f732c00_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f732c00__finalize_spec");
      begin
         F1;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c732c01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f732c00.o
