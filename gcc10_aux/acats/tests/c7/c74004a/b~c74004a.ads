...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c74004a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8d6cb3b9#;
   pragma Export (C, u00001, "c74004aB");
   ...
   u00148 : constant Version_32 := 16#9ef7df63#;
   pragma Export (C, u00148, "system__boolean_array_operationsS");
   u00149 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00149, "system__address_operationsB");
   u00150 : constant Version_32 := 16#b55bac24#;
   pragma Export (C, u00150, "system__address_operationsS");
   u00151 : constant Version_32 := 16#db92bda7#;
   pragma Export (C, u00151, "system__vectorsS");
   u00152 : constant Version_32 := 16#9fa5cd3a#;
   pragma Export (C, u00152, "system__vectors__boolean_operationsB");
   u00153 : constant Version_32 := 16#b42bd080#;
   pragma Export (C, u00153, "system__vectors__boolean_operationsS");
   ...
   u00180 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00180, "system__val_intB");
   u00181 : constant Version_32 := 16#13a87b74#;
