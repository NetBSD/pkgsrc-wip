pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c760001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c760001.adb");
...
package body ada_main is
   ...
   E108 : Short_Integer; pragma Import (Ada, E108, "c760001_0_E");
   E135 : Short_Integer; pragma Import (Ada, E135, "c760001_1_E");
   E139 : Short_Integer; pragma Import (Ada, E139, "impdef_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "tctouch_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c760001_1__finalize_spec");
      begin
         F1;
      end;
      E108 := E108 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c760001_0__finalize_spec");
      begin
         F2;
      end;
      E116 := E116 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c760001");
