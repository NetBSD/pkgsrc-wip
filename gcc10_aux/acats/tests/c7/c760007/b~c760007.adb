pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c760007.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c760007.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c760007_0_E");
   E122 : Short_Integer; pragma Import (Ada, E122, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c760007_0__finalize_spec");
      begin
         F1;
      end;
      E128 := E128 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c760007");
