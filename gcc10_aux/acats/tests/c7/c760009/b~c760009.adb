pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c760009.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c760009.adb");
...
package body ada_main is
   ...
   E123 : Short_Integer; pragma Import (Ada, E123, "system__storage_pools__subpools_E");
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c760009_1_E");
   E135 : Short_Integer; pragma Import (Ada, E135, "c760009_2_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "c760009_3_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c760009_3__finalize_spec");
      begin
         F1;
      end;
      E135 := E135 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c760009_2__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c760009_1__finalize_spec");
      begin
         F3;
      end;
      E111 := E111 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c760009");
