pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c760012.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c760012.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "c760012_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c760012_0__finalize_spec");
      begin
         F1;
      end;
      E149 := E149 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c760012");
