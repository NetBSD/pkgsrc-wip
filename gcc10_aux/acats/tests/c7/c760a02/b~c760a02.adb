pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c760a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c760a02.adb");
...
package body ada_main is
   ...
   E175 : Short_Integer; pragma Import (Ada, E175, "impdef_E");
   E173 : Short_Integer; pragma Import (Ada, E173, "tctouch_E");
   E124 : Short_Integer; pragma Import (Ada, E124, "f760a00_E");
   E193 : Short_Integer; pragma Import (Ada, E193, "f760a00__child_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c760a02a_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "f760a00__child__finalize_spec");
      begin
         F1;
      end;
      E124 := E124 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f760a00__finalize_spec");
      begin
         F2;
      end;
      E116 := E116 - 1;
   ...
   begin
      ...
      F760A00'ELAB_BODY;
      E124 := E124 + 1;
      F760A00.CHILD'ELAB_SPEC;
      F760A00.CHILD'ELAB_BODY;
      E193 := E193 + 1;
      E103 := E103 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c760a02");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f760a00.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f760a00-child.o
   --   ./c760a02a.o
   --   ./c760a02.o
   --   -L./
