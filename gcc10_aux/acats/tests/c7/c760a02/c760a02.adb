...
begin
   ...
   -- Object declarations:
   declare
      My_Obj : F760A00.Lim_Rec := C760A02A.Func_Lim_Rec (Int => 1);
   begin
   ...
   declare
      My_Prot : F760A00.Lim_Comp :=
         C760A02A.Func_Lim_Comp (Int => Report.Ident_Int(1));
   begin
   ...
   declare
      My_Arr : F760A00.Lim_Array :=
         C760A02A.Func_Lim_Array (Int => Report.Ident_Int(5));
   begin
   ...
   declare
      My_Ext : F760A00.Child.Lim_Ext :=
          C760A02A.Func_Lim_Ext (Int => Report.Ident_Int(10));
   begin
   ...
   declare
      type A_Rec is record
         C : F760A00.Lim_Rec :=
            C760A02A.Func_Lim_Rec (Int => Report.Ident_Int(12));
         N : Natural := 0;
      end record;
      My_Rec : A_Rec;
   begin
   ...
   declare
      type A_Rec is record
         C : F760A00.Child.Lim_Ext := C760A02A.Func_Lim_Ext (Int => 20);
         D : Character := 'A';
      end record;
      My_Rec : A_Rec;
   begin
   ...
   declare
      type A_Rec is record
         C : F760A00.Lim_Comp :=
             C760A02A.Func_Lim_Comp (Int => Report.Ident_Int(3));
         A : Natural := 10;
      end record;
      My_Rec : A_Rec;
   begin
   ...
   declare
      My_Arr : F760A00.Lim_Array := (1 .. Report.Ident_Int(4) =>
                C760A02A.Func_Lim_Rec (Int => Report.Ident_Int(10)));
   begin
   ...
   declare
      My_Tag : F760A00.Lim_Tagged := (R => C760A02A.Func_Lim_Rec (Int => 12),
                                      TC => <>);
   begin
   ...
   declare
      My_Ext : F760A00.Child.Lim_Ext :=
        (F760A00.Lim_Tagged'(R => C760A02A.Func_Lim_Rec (Int => 8),
                             TC => <>) with
   ...
   declare
      My_Arr : F760A00.Lim_Array := (
         C760A02A.Func_Lim_Rec (Int => 4),
         C760A02A.Func_Lim_Rec (Int => 6));
   begin
   ...
   declare
       ...
       Obj : Acc_Comp := new F760A00.Lim_Comp'(
            C760A02A.Func_Lim_Comp (Int => Report.Ident_Int(4)));
   begin
   ...
   declare
      generic
         Test : in F760A00.Lim_Rec := C760A02A.Func_Lim_Rec (Int => 3);
      procedure Check_It;
   ...
   declare
      ...
      procedure My_Check_It is new Check_It (C760A02A.Func_Lim_Rec (Int => 7));
   begin
      My_Check_It;
   end;
