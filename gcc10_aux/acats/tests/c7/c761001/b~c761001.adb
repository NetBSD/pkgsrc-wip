pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c761001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c761001.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "c761001_1_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c761001_0_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c761001_0__finalize_body");
      begin
         E005 := E005 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c761001_0__finalize_spec");
      begin
         F2;
      end;
      E167 := E167 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c761001");
