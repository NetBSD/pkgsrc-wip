pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c761006.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c761006.adb");
...
package body ada_main is
   ...
   E110 : Short_Integer; pragma Import (Ada, E110, "c761006_support_E");
   E108 : Short_Integer; pragma Import (Ada, E108, "c761006_0_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "c761006_1_E");
   E136 : Short_Integer; pragma Import (Ada, E136, "c761006_2_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c761006_2__finalize_spec");
      begin
         E136 := E136 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c761006_1__finalize_spec");
      begin
         E137 := E137 - 1;
         F2;
      end;
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "c761006_0__finalize_spec");
      begin
         F3;
      end;
      E139 := E139 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c761006");
