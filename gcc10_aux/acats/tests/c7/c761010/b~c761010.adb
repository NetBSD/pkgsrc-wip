pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c761010.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c761010.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c761010_1_E");
   E124 : Short_Integer; pragma Import (Ada, E124, "c761010_1__var_strings_E");
   E140 : Short_Integer; pragma Import (Ada, E140, "c761010_1__var_strings__types_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c761010_1__var_strings__types__finalize_spec");
      begin
         F1;
      end;
      E124 := E124 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c761010_1__var_strings__finalize_spec");
      begin
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c761010_1__finalize_body");
      begin
         E005 := E005 - 1;
         F3;
      end;
      declare
         procedure F4;
         pragma Import (Ada, F4, "c761010_1__finalize_spec");
      begin
         F4;
      end;
      E142 := E142 - 1;
   ...
   begin
      ...
      C761010_1'Elab_Body;
      E005 := E005 + 1;
      C761010_1.Var_Strings'Elab_Spec;
      C761010_1.Var_Strings'Elab_Body;
      E124 := E124 + 1;
      C761010_1.Var_Strings.Types'Elab_Spec;
      C761010_1.Var_Strings.Types'Elab_Body;
      E140 := E140 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c761010");
...
--  BEGIN Object file/option list
   ...
   --   ./c761010_1.o
   --   ./c761010_1-var_strings.o
   --   ./c761010_1-var_strings-types.o
   --   ./c761010_1-main.o
   --   ./c761010.o
   --   -L./
