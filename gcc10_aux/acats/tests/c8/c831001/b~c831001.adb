pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c831001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c831001.adb");
...
package body ada_main is
   ...
   E107 : Short_Integer; pragma Import (Ada, E107, "c831001_root_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "c831001_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "c831001_0__c831001_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c831001_0__c831001_1__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c831001_0__finalize_spec");
      begin
         F2;
      end;
      E107 := E107 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c831001_root__finalize_spec");
      begin
         F3;
      end;
      E119 := E119 - 1;
   ...
   begin
      ...
      E119 := E119 + 1;
      C831001_Root'Elab_Spec;
      C831001_Root'Elab_Body;
      E107 := E107 + 1;
      C831001_0'Elab_Spec;
      C831001_0'Elab_Body;
      E005 := E005 + 1;
      C831001_0.C831001_1'Elab_Spec;
      C831001_0.C831001_1'Elab_Body;
      E111 := E111 + 1;
      Report'Elab_Body;
      E113 := E113 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c831001");
