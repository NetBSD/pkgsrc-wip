pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c930001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c930001.adb");
...
package body ada_main is
   ...
   E137 : Short_Integer; pragma Import (Ada, E137, "c930001_0_E");
   E159 : Short_Integer; pragma Import (Ada, E159, "impdef_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c930001_0__finalize_spec");
      begin
         F1;
      end;
      E187 := E187 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c930001");
