pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c93005d.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c93005d.adb");
...
package body ada_main is
   ...
   E153 : Short_Integer; pragma Import (Ada, E153, "c93005d_pk1_E");
   E137 : Short_Integer; pragma Import (Ada, E137, "c93005d_enqueue_E");
   ...
   begin
      ...
      Report'Elab_Body;
      E139 := E139 + 1;
      C93005D_PK1'ELAB_SPEC;
      C93005D_PK1'ELAB_BODY;
      E153 := E153 + 1;
      E137 := E137 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c93005d");
