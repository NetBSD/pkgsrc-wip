pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c93005f.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c93005f.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "c93005f_pk1_E");
   ...
   begin
      ...
      Report'Elab_Body;
      E170 := E170 + 1;
      C93005F_PK1'ELAB_SPEC;
      C93005F_PK1'ELAB_BODY;
      E005 := E005 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c93005f");
