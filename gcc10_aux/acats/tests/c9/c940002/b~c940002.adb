pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c940002.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c940002.adb");
...
package body ada_main is
   ...
   E109 : Short_Integer; pragma Import (Ada, E109, "c940002_0_E");
   E168 : Short_Integer; pragma Import (Ada, E168, "report_E");
   E166 : Short_Integer; pragma Import (Ada, E166, "c940002_1_E");
   E181 : Short_Integer; pragma Import (Ada, E181, "impdef_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c940002_1__finalize_spec");
      begin
         F1;
      end;
      E109 := E109 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c940002_0__finalize_spec");
      begin
         F2;
      end;
      E143 := E143 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c940002");
