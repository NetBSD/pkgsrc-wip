pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c94001g.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c94001g.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c94001g");
