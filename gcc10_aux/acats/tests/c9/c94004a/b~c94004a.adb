pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c94004a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c94004a.adb");
...
package body ada_main is
   ...
   E006 : Short_Integer; pragma Import (Ada, E006, "c94004a_pkg_E");
   E004 : Short_Integer; pragma Import (Ada, E004, "c94004a_task_E");
   ...
   begin
      ...
      E142 := E142 + 1;
      E112 := E112 + 1;
      C94004A_PKG'ELAB_BODY;
      E006 := E006 + 1;
      C94004A_TASK'ELAB_SPEC;
      E004 := E004 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_c94004a");
