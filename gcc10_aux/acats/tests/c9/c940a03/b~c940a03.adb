pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c940a03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c940a03.adb");
...
package body ada_main is
   ...
   E165 : Short_Integer; pragma Import (Ada, E165, "c940a03_0_E");
   E169 : Short_Integer; pragma Import (Ada, E169, "f940a00_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "c940a03_1_E");
   E173 : Short_Integer; pragma Import (Ada, E173, "report_E");
   E171 : Short_Integer; pragma Import (Ada, E171, "c940a03_2_E");
   E186 : Short_Integer; pragma Import (Ada, E186, "impdef_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c940a03_1__finalize_spec");
      begin
         F1;
      end;
      E169 := E169 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "f940a00__finalize_spec");
      begin
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c940a03_0__finalize_spec");
      begin
         E165 := E165 - 1;
         F3;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c940a03");
...
--  BEGIN Object file/option list
   --   ./c940a03_0.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/f940a00.o
   --   ./c940a03_1.o
