pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c950001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c950001.adb");
...
package body ada_main is
   ...
   E135 : Short_Integer; pragma Import (Ada, E135, "c950001_0_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "c950001_1_E");
   E182 : Short_Integer; pragma Import (Ada, E182, "report_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "c950001_1__finalize_body");
      begin
         E103 := E103 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "c950001_1__finalize_spec");
      begin
         F2;
      end;
      E135 := E135 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "c950001_0__finalize_spec");
      begin
         F3;
      end;
      E162 := E162 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c950001");
