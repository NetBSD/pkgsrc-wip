pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c95008a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c95008a.adb");
...
package body ada_main is
   ...
   E163 : Short_Integer; pragma Import (Ada, E163, "report_E");
   E133 : Short_Integer; pragma Import (Ada, E133, "impdef_E");
   ...
   begin
      ...
      System.Restrictions.Run_Time_Restrictions :=
        (Set =>
         ...
         Count => (0, 0, 0, 0, 2, 11, 1, 0, 0, 0),
         Unknown => (False, False, False, False, False, True, True, False, False, False));
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c95008a");
