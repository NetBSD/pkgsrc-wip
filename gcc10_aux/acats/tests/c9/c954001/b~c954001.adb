pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~c954001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~c954001.adb");
...
package body ada_main is
   ...
   E137 : Short_Integer; pragma Import (Ada, E137, "c954001_0_E");
   E193 : Short_Integer; pragma Import (Ada, E193, "report_E");
   E168 : Short_Integer; pragma Import (Ada, E168, "impdef_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "c954001_0__finalize_spec");
      begin
         F1;
      end;
      E145 := E145 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_c954001");
