...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_c96008a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1ebf93e7#;
   pragma Export (C, u00001, "c96008aB");
   ...
   u00102 : constant Version_32 := 16#6bf8b2ed#;
   pragma Export (C, u00102, "calendarS");
