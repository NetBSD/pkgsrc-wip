pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca11006.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca11006.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "ca11006_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "ca11006_0__ca11006_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "ca11006_0__ca11006_1__finalize_spec");
      begin
         F1;
      end;
      E005 := E005 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "ca11006_0__finalize_spec");
      begin
         F2;
      end;
      E117 := E117 - 1;
   ...
   begin
      ...
      CA11006_0'ELAB_SPEC;
      E005 := E005 + 1;
      CA11006_0.CA11006_1'ELAB_SPEC;
      CA11006_0.CA11006_1'ELAB_BODY;
      E109 := E109 + 1;
      Report'Elab_Body;
      E111 := E111 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca11006");
