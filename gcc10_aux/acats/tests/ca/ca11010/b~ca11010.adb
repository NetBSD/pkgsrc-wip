pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca11010.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca11010.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "ca11010_0_E");
   E007 : Short_Integer; pragma Import (Ada, E007, "ca11010_0__ca11010_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "ca11010_0__finalize_spec");
      begin
         F1;
      end;
      E117 := E117 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca11010");
