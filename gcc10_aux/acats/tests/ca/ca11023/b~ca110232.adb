pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca110232.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca110232.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "ca11023d_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "ca11023e_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "ca11023e__finalize_spec");
      begin
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "ca11023d__finalize_spec");
      begin
         F2;
      end;
      E125 := E125 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca110232");
