pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca11a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca11a01.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "fa11a00_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "fa11a00__ca11a01_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "fa11a00__ca11a01_0__ca11a01_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "fa11a00__ca11a01_0__ca11a01_1__finalize_spec");
      begin
         F1;
      end;
      E109 := E109 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "fa11a00__ca11a01_0__finalize_spec");
      begin
         F2;
      end;
      E005 := E005 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "fa11a00__finalize_spec");
      begin
         F3;
      end;
      E121 := E121 - 1;
   ...
   begin
      ...
      FA11A00'ELAB_BODY;
      E005 := E005 + 1;
      FA11A00.CA11A01_0'ELAB_SPEC;
      FA11A00.CA11A01_0'ELAB_BODY;
      E109 := E109 + 1;
      FA11A00.CA11A01_0.CA11A01_1'ELAB_SPEC;
      FA11A00.CA11A01_0.CA11A01_1'ELAB_BODY;
      E111 := E111 + 1;
      Report'Elab_Body;
      E115 := E115 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca11a01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fa11a00.o
   --   ./fa11a00-ca11a01_0.o
   --   ./fa11a00-ca11a01_0-ca11a01_1.o
