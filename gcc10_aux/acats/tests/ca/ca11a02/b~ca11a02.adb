pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca11a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca11a02.adb");
...
package body ada_main is
   ...
   E106 : Short_Integer; pragma Import (Ada, E106, "fa11a00_E");
   E110 : Short_Integer; pragma Import (Ada, E110, "fa11a00__ca11a02_0_E");
   E004 : Short_Integer; pragma Import (Ada, E004, "ca11a02_1_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "ca11a02_1__finalize_spec");
      begin
         E004 := E004 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "fa11a00__ca11a02_0__finalize_spec");
      begin
         F2;
      end;
      E106 := E106 - 1;
   ...
   begin
      ...
      FA11A00'ELAB_BODY;
      E106 := E106 + 1;
      FA11A00.CA11A02_0'ELAB_SPEC;
      FA11A00.CA11A02_0'ELAB_BODY;
      E110 := E110 + 1;
      CA11A02_1'ELAB_SPEC;
      E004 := E004 + 1;
      Report'Elab_Body;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca11a02");
