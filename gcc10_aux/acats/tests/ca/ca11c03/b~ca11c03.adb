pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca11c03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca11c03.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "fa11c00_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "fa11c00_0__fa11c00_1_E");
   E113 : Short_Integer; pragma Import (Ada, E113, "fa11c00_0__fa11c00_1__fa11c00_2_E");
   E115 : Short_Integer; pragma Import (Ada, E115, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "fa11c00_0__fa11c00_1__fa11c00_2__finalize_spec");
      begin
         F1;
      end;
      E111 := E111 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "fa11c00_0__fa11c00_1__finalize_spec");
      begin
         F2;
      end;
      E103 := E103 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "fa11c00_0__finalize_spec");
      begin
         F3;
      end;
      E121 := E121 - 1;
   ...
   begin
      ...
      FA11C00_0'ELAB_BODY;
      E103 := E103 + 1;
      FA11C00_0.FA11C00_1'ELAB_SPEC;
      FA11C00_0.FA11C00_1'ELAB_BODY;
      E111 := E111 + 1;
      FA11C00_0.FA11C00_1.FA11C00_2'ELAB_SPEC;
      FA11C00_0.FA11C00_1.FA11C00_2'ELAB_BODY;
      E113 := E113 + 1;
      Report'Elab_Body;
      E115 := E115 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca11c03");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fa11c00_0.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fa11c00_0-fa11c00_1.o
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fa11c00_0-fa11c00_1-fa11c00_2.o
