pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ca120012.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ca120012.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "ca12001_win_E");
   E105 : Short_Integer; pragma Import (Ada, E105, "ca12001_win__impl_E");
   E150 : Short_Integer; pragma Import (Ada, E150, "report_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "ca12001_win__finalize_spec");
      begin
         F1;
      end;
      E107 := E107 - 1;
   ...
   begin
      ...
      E107 := E107 + 1;
      Ca12001_Win'Elab_Spec;
      E105 := E105 + 1;
      Ca12001_Win'Elab_Body;
      E103 := E103 + 1;
      Report'Elab_Body;
      E150 := E150 + 1;
   end adainit;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ca120012");
