...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cb20a02" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f0cb953d#;
   pragma Export (C, u00001, "cb20a02B");
   ...
   u00096 : constant Version_32 := 16#9a666dc0#;
   pragma Export (C, u00096, "fb20a00B");
   u00097 : constant Version_32 := 16#9e81f3ce#;
   pragma Export (C, u00097, "fb20a00S");
