pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cc30001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cc30001.adb");
...
package body ada_main is
   ...
   E106 : Short_Integer; pragma Import (Ada, E106, "cc30001_0_E");
   E114 : Short_Integer; pragma Import (Ada, E114, "cc30001_1_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "cc30001_2_E");
   E112 : Short_Integer; pragma Import (Ada, E112, "cc30001_3_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cc30001_2__finalize_spec");
      begin
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "cc30001_0__finalize_spec");
      begin
         E106 := E106 - 1;
         F2;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cc30001");
