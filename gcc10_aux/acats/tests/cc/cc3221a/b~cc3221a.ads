...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cc3221a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#fe0afbb3#;
   pragma Export (C, u00001, "cc3221aB");
   ...
   u00122 : constant Version_32 := 16#dde34de3#;
   pragma Export (C, u00122, "system__exp_intB");
   u00123 : constant Version_32 := 16#bf7424eb#;
   pragma Export (C, u00123, "system__exp_intS");
