...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cc3232a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f708c0fa#;
   pragma Export (C, u00001, "cc3232aB");
   ...
   u00122 : constant Version_32 := 16#0d64ce42#;
   pragma Export (C, u00122, "system__fat_sfltS");
