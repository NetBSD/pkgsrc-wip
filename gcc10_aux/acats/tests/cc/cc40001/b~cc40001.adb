pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cc40001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cc40001.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "report_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "impdef_E");
   E123 : Short_Integer; pragma Import (Ada, E123, "tctouch_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "cc40001_0_E");
   E167 : Short_Integer; pragma Import (Ada, E167, "cc40001_0__cc40001_1_E");
   E169 : Short_Integer; pragma Import (Ada, E169, "cc40001_0__cc40001_2_E");
   E171 : Short_Integer; pragma Import (Ada, E171, "cc40001_0__cc40001_3_E");
   E173 : Short_Integer; pragma Import (Ada, E173, "cc40001_0__cc40001_4_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cc40001_0__cc40001_1__finalize_body");
      begin
         E167 := E167 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "cc40001_0__cc40001_1__finalize_spec");
      begin
         F2;
      end;
      declare
         procedure F3;
         pragma Import (Ada, F3, "cc40001_0__finalize_body");
      begin
         E103 := E103 - 1;
         F3;
      end;
      declare
         procedure F4;
         pragma Import (Ada, F4, "cc40001_0__finalize_spec");
      begin
         F4;
      end;
      E111 := E111 - 1;
   ...
   begin
      ...
      CC40001_0'ELAB_BODY;
      E103 := E103 + 1;
      CC40001_0.CC40001_1'ELAB_SPEC;
      CC40001_0.CC40001_1'ELAB_BODY;
      E167 := E167 + 1;
      E169 := E169 + 1;
      E171 := E171 + 1;
      E173 := E173 + 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cc40001");
...
--  BEGIN Object file/option list
   ...
   --   ./cc40001_0.o
   --   ./cc40001_0-cc40001_1.o
   --   ./cc40001_0-cc40001_2.o
   --   ./cc40001_0-cc40001_3.o
   --   ./cc40001_0-cc40001_4.o
   --   ./cc40001.o
   --   -L./
