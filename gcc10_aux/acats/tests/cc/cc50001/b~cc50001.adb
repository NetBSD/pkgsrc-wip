pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cc50001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cc50001.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "cc50001_0_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "cc50001_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cc50001_0__finalize_spec");
      begin
         F1;
      end;
      E119 := E119 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cc50001");
