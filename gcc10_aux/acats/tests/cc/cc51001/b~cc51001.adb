pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cc51001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cc51001.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "cc51001_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "cc51001_1_E");
   E111 : Short_Integer; pragma Import (Ada, E111, "cc51001_2_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cc51001_1__finalize_spec");
      begin
         E109 := E109 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "cc51001_0__finalize_spec");
      begin
         E102 := E102 - 1;
         F2;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cc51001");
