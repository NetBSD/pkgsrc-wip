pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cc51b03.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cc51b03.adb");
...
package body ada_main is
   ...
   E006 : Short_Integer; pragma Import (Ada, E006, "fc51b00_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "cc51b03_0_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "cc51b03_1_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cc51b03_1__finalize_spec");
      begin
         E109 := E109 - 1;
         F1;
      end;
      declare
         procedure F2;
         pragma Import (Ada, F2, "fc51b00__finalize_spec");
      begin
         E006 := E006 - 1;
         F2;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cc51b03");
