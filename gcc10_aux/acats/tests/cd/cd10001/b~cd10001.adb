pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cd10001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cd10001.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "cd10001_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cd10001_0__finalize_spec");
      begin
         F1;
      end;
      E145 := E145 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cd10001");
