pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cd10002.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cd10002.adb");
...
package body ada_main is
   ...
   E179 : Short_Integer; pragma Import (Ada, E179, "ada__real_time_E");
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "cd10002_0_E");
   E125 : Short_Integer; pragma Import (Ada, E125, "cd10002_deriv_E");
   E181 : Short_Integer; pragma Import (Ada, E181, "cd10002_gen_E");
   E183 : Short_Integer; pragma Import (Ada, E183, "cd10002_priv_E");
   E109 : Short_Integer; pragma Import (Ada, E109, "report_E");
   E107 : Short_Integer; pragma Import (Ada, E107, "cd10002_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cd10002_1__finalize_spec");
      begin
         F1;
      end;
      E183 := E183 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "cd10002_priv__finalize_spec");
      begin
         F2;
      end;
      E169 := E169 - 1;
   ...
   begin
      ...
      E153 := E153 + 1;
      E105 := E105 + 1;
      Cd10002_Deriv'Elab_Body;
      E125 := E125 + 1;
      E181 := E181 + 1;
      Cd10002_Priv'Elab_Spec;
      E183 := E183 + 1;
      Report'Elab_Body;
      E109 := E109 + 1;
      CD10002_1'ELAB_SPEC;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cd10002");
