...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cd2a21e" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f82a2630#;
   pragma Export (C, u00001, "cd2a21eB");
   ...
   u00123 : constant Version_32 := 16#c456f9ec#;
