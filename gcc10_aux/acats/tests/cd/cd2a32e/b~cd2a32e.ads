...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cd2a32e" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#00fb6770#;
   pragma Export (C, u00001, "cd2a32eB");
   ...
   u00120 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00120, "system__val_intB");
   u00121 : constant Version_32 := 16#13a87b74#;
