pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cd30001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cd30001.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "cd30001_0_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cd30001_0__finalize_body");
      begin
         E005 := E005 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cd30001");
