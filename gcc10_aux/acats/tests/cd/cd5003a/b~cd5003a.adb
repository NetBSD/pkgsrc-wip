pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cd5003a.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cd5003a.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "cd5003a_pkg2_E");
   ...
   begin
      ...
      Report'Elab_Body;
      E007 := E007 + 1;
      CD5003A_PKG2'ELAB_BODY;
      E005 := E005 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_cd5003a");
