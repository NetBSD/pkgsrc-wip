pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cd5003h.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cd5003h.adb");
...
package body ada_main is
   ...
   E005 : Short_Integer; pragma Import (Ada, E005, "cd5003h_pack3_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cd5003h");
