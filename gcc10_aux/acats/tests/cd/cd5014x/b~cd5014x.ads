...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cd5014x" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#57372503#;
   pragma Export (C, u00001, "cd5014xB");
   ...
   u00122 : constant Version_32 := 16#8f461df5#;
