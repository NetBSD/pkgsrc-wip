...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cd70001" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#b2de1aff#;
   pragma Export (C, u00001, "cd70001B");
   ...
   u00006 : constant Version_32 := 16#971fad3a#;
