...
PROCEDURE CD7101G IS
     ...
     TEST_VAR : LONG_LONG_INTEGER := 0;                    -- N/A => ERROR.
...
BEGIN
     ...
     IF LONG_LONG_INTEGER'POS (LONG_LONG_INTEGER'FIRST) < SYSTEM.MIN_INT THEN
          FAILED ("INCORRECT VALUE FOR SYSTEM.MIN_INT");
     END IF;

     IF LONG_LONG_INTEGER'POS (LONG_LONG_INTEGER'LAST) > SYSTEM.MAX_INT THEN
