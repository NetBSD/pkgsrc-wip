pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdb0002.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdb0002.adb");
...
package body ada_main is
   ...
   E145 : Short_Integer; pragma Import (Ada, E145, "system__pool_size_E");
   E133 : Short_Integer; pragma Import (Ada, E133, "report_E");
   E103 : Short_Integer; pragma Import (Ada, E103, "impdef_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "system__pool_size__finalize_spec");
      begin
         F1;
      end;
      E139 := E139 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdb0002");
