pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdb0a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdb0a01.adb");
...
package body ada_main is
   ...
   E143 : Short_Integer; pragma Import (Ada, E143, "report_E");
   E118 : Short_Integer; pragma Import (Ada, E118, "impdef_E");
   E116 : Short_Integer; pragma Import (Ada, E116, "tctouch_E");
   E149 : Short_Integer; pragma Import (Ada, E149, "fdb0a00_E");
   E164 : Short_Integer; pragma Import (Ada, E164, "fdb0a00__comparator_E");
   E150 : Short_Integer; pragma Import (Ada, E150, "fdb0a00__pool1_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "cdb0a01_2_E");
   E162 : Short_Integer; pragma Import (Ada, E162, "cdb0a01_3_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "fdb0a00__pool1__finalize_spec");
      begin
         E150 := E150 - 1;
         F1;
      end;
      ...
      declare
         procedure F2;
         pragma Import (Ada, F2, "fdb0a00__finalize_spec");
      begin
         F2;
      end;
      E152 := E152 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdb0a01");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fdb0a00.o
   --   ./fdb0a00-comparator.o
   --   ./fdb0a00-pool1.o
   --   ./cdb0a01_2.o
   --   ./cdb0a01_3.o
   --   ./cdb0a01.o
