pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdb0a02.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdb0a02.adb");
...
package body ada_main is
   ...
   E150 : Short_Integer; pragma Import (Ada, E150, "fdb0a00__pool2_E");
   E005 : Short_Integer; pragma Import (Ada, E005, "cdb0a02_2_E");
   E162 : Short_Integer; pragma Import (Ada, E162, "cdb0a02_3_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "fdb0a00__pool2__finalize_spec");
      begin
         E150 := E150 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdb0a02");
