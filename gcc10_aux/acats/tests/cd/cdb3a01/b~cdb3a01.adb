pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdb3a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdb3a01.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "fdb3a00_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "fdb3a00__finalize_spec");
      begin
         F1;
      end;
      E147 := E147 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdb3a01");
...
--  BEGIN Object file/option list
   ...
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fdb3a00.o
   --   ./cdb3a01.o
   --   -L./
