pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdd2001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdd2001.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "cdd2001_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cdd2001_0__finalize_spec");
      begin
         F1;
      end;
      E114 := E114 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdd2001");
