pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cdd2a01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cdd2a01.adb");
...
package body ada_main is
   ...
   E105 : Short_Integer; pragma Import (Ada, E105, "fdd2a00_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "fdd2a00__finalize_spec");
      begin
         F1;
      end;
      E113 := E113 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cdd2a01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fdd2a00.o
