pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~ce3409c.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~ce3409c.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_ce3409c");
