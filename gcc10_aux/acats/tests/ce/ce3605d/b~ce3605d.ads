...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ce3605d" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#df280c29#;
   pragma Export (C, u00001, "ce3605dB");
   ...
   u00102 : constant Version_32 := 16#a755b46c#;
   pragma Export (C, u00102, "check_fileB");
