...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ce3706f" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#70c58feb#;
   pragma Export (C, u00001, "ce3706fB");
   ...
   u00132 : constant Version_32 := 16#a755b46c#;
   pragma Export (C, u00132, "check_fileB");
