...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ce3810a" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#0948619f#;
   pragma Export (C, u00001, "ce3810aB");
   ...
   u00097 : constant Version_32 := 16#971fad3a#;
