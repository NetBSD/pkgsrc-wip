...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_ce3905c" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c4068fca#;
   pragma Export (C, u00001, "ce3905cB");
   ...
   u00126 : constant Version_32 := 16#8f461df5#;
