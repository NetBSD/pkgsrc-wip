...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxa4035" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a59077ab#;
   pragma Export (C, u00001, "cxa4035B");
   ...
   u00106 : constant Version_32 := 16#22d17b05#;
   pragma Export (C, u00106, "ada__strings__equal_case_insensitiveB");
   u00107 : constant Version_32 := 16#a7ec4680#;
   pragma Export (C, u00107, "ada__strings__equal_case_insensitiveS");
   u00108 : constant Version_32 := 16#bf363ed2#;
   pragma Export (C, u00108, "ada__strings__fixedB");
   u00109 : constant Version_32 := 16#fec1aafc#;
   pragma Export (C, u00109, "ada__strings__fixedS");
   u00110 : constant Version_32 := 16#0a46a227#;
   pragma Export (C, u00110, "ada__strings__fixed__equal_case_insensitiveS");
   u00111 : constant Version_32 := 16#a4a07691#;
   pragma Export (C, u00111, "ada__strings__fixed__less_case_insensitiveS");
   u00112 : constant Version_32 := 16#5d1b3d81#;
   pragma Export (C, u00112, "ada__strings__less_case_insensitiveB");
   u00113 : constant Version_32 := 16#9c017ef5#;
   pragma Export (C, u00113, "ada__strings__less_case_insensitiveS");
   u00114 : constant Version_32 := 16#351539c5#;
   pragma Export (C, u00114, "ada__strings__unboundedB");
   u00115 : constant Version_32 := 16#6552cb60#;
   ...
   u00122 : constant Version_32 := 16#a02f73f2#;
   pragma Export (C, u00122, "system__storage_pools__subpoolsB");
   u00123 : constant Version_32 := 16#cc5a1856#;
   pragma Export (C, u00123, "system__storage_pools__subpoolsS");
   u00124 : constant Version_32 := 16#57674f80#;
   pragma Export (C, u00124, "system__finalization_mastersB");
   u00125 : constant Version_32 := 16#fdab2bdd#;
   ...
   u00127 : constant Version_32 := 16#538e63fc#;
   ...
   u00134 : constant Version_32 := 16#85ba8cba#;
   ...
   u00138 : constant Version_32 := 16#120b3f9a#;
   pragma Export (C, u00138, "system__atomic_countersS");
   u00139 : constant Version_32 := 16#039168f8#;
   ...
   u00141 : constant Version_32 := 16#eea87217#;
   pragma Export (C, u00141, "ada__strings__unbounded__equal_case_insensitiveB");
   u00142 : constant Version_32 := 16#9906a21a#;
   pragma Export (C, u00142, "ada__strings__unbounded__equal_case_insensitiveS");
   u00143 : constant Version_32 := 16#da8cbe06#;
   pragma Export (C, u00143, "ada__strings__unbounded__auxB");
   u00144 : constant Version_32 := 16#75ee9817#;
   pragma Export (C, u00144, "ada__strings__unbounded__auxS");
   u00145 : constant Version_32 := 16#c36d294f#;
   pragma Export (C, u00145, "ada__strings__unbounded__less_case_insensitiveB");
   u00146 : constant Version_32 := 16#ca10e1aa#;
   pragma Export (C, u00146, "ada__strings__unbounded__less_case_insensitiveS");
   u00147 : constant Version_32 := 16#92f3335b#;
   pragma Export (C, u00147, "reportB");
   u00148 : constant Version_32 := 16#df19fbea#;
   pragma Export (C, u00148, "reportS");
   u00149 : constant Version_32 := 16#fc54e290#;
   pragma Export (C, u00149, "ada__calendarB");
   u00150 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00150, "ada__calendarS");
   u00151 : constant Version_32 := 16#51f2d040#;
   pragma Export (C, u00151, "system__os_primitivesB");
   u00152 : constant Version_32 := 16#a1aa77e1#;
   pragma Export (C, u00152, "system__os_primitivesS");
   u00153 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00153, "ada__text_ioB");
   u00154 : constant Version_32 := 16#971fad3a#;
   ...
   --  ada.strings.fixed%s
   --  ada.strings.fixed%b
   --  ada.strings.fixed.equal_case_insensitive%s
   --  ada.strings.fixed.less_case_insensitive%s
   ...
   --  ada.strings.unbounded.less_case_insensitive%s
   --  ada.strings.unbounded.less_case_insensitive%b
   --  ada.calendar%s
   --  ada.calendar%b
   --  ada.text_io%s
   --  ada.text_io%b
