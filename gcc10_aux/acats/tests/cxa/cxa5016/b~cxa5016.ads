...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxa5016" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#338be8ba#;
   pragma Export (C, u00001, "cxa5016B");
   ...
   u00120 : constant Version_32 := 16#fe220e03#;
   pragma Export (C, u00120, "system__fat_fltS");
   u00121 : constant Version_32 := 16#d810070e#;
