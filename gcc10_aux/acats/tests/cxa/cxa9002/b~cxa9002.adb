pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxa9002.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxa9002.adb");
...
package body ada_main is
   ...
   E126 : Short_Integer; pragma Import (Ada, E126, "system__direct_io_E");
   E102 : Short_Integer; pragma Import (Ada, E102, "cxa9002_0_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxa9002_0__finalize_spec");
      begin
         E102 := E102 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxa9002");
