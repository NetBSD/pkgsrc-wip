...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaa009" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c84f7ff2#;
   pragma Export (C, u00001, "cxaa009B");
   ...
   u00136 : constant Version_32 := 16#0d64ce42#;
