...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaa016" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c9c5ff9b#;
   pragma Export (C, u00001, "cxaa016B");
   ...
   u00114 : constant Version_32 := 16#acef8cd8#;
   pragma Export (C, u00114, "cxaa016_0S");
