...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaa017" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eb15796e#;
   pragma Export (C, u00001, "cxaa017B");
   ...
   u00114 : constant Version_32 := 16#816fbb47#;
   pragma Export (C, u00114, "cxaa017_0S");
