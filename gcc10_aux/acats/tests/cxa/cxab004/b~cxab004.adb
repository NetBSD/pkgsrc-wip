pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxab004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxab004.adb");
...
package body ada_main is
   ...
   E101 : Short_Integer; pragma Import (Ada, E101, "ada__strings__wide_maps_E");
   E097 : Short_Integer; pragma Import (Ada, E097, "ada__strings__wide_unbounded_E");
   ...
   begin
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "ada__strings__wide_unbounded__finalize_spec");
      begin
         F3;
      end;
      E101 := E101 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "ada__strings__wide_maps__finalize_spec");
      begin
         F4;
      end;
      E109 := E109 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxab004");
