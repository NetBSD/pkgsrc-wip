pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxab005.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxab005.adb");
...
package body ada_main is
   ...
   E101 : Short_Integer; pragma Import (Ada, E101, "ada__strings__wide_wide_maps_E");
   E097 : Short_Integer; pragma Import (Ada, E097, "ada__strings__wide_wide_unbounded_E");
   E144 : Short_Integer; pragma Import (Ada, E144, "ada__calendar_E");
   E148 : Short_Integer; pragma Import (Ada, E148, "ada__text_io_E");
   E132 : Short_Integer; pragma Import (Ada, E132, "ada__wide_wide_text_io_E");
   ...
   begin
      ...
      declare
         procedure F3;
         pragma Import (Ada, F3, "ada__strings__wide_wide_unbounded__finalize_spec");
      begin
         F3;
      end;
      E101 := E101 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "ada__strings__wide_wide_maps__finalize_spec");
      begin
         F4;
      end;
      E109 := E109 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxab005");
