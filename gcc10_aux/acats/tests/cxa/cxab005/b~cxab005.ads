...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxab005" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ed9347f0#;
   pragma Export (C, u00001, "cxab005B");
   ...
   u00096 : constant Version_32 := 16#11bdde56#;
   pragma Export (C, u00096, "ada__strings__wide_wide_unboundedB");
   u00097 : constant Version_32 := 16#3b37c8f4#;
   pragma Export (C, u00097, "ada__strings__wide_wide_unboundedS");
   u00098 : constant Version_32 := 16#37e87c8e#;
   pragma Export (C, u00098, "ada__strings__wide_wide_searchB");
   u00099 : constant Version_32 := 16#ff3339af#;
   pragma Export (C, u00099, "ada__strings__wide_wide_searchS");
   u00100 : constant Version_32 := 16#f4eea38a#;
   pragma Export (C, u00100, "ada__strings__wide_wide_mapsB");
   u00101 : constant Version_32 := 16#cf20fccc#;
   pragma Export (C, u00101, "ada__strings__wide_wide_mapsS");
   ...
   u00108 : constant Version_32 := 16#a02f73f2#;
   ...
   u00110 : constant Version_32 := 16#57674f80#;
   pragma Export (C, u00110, "system__finalization_mastersB");
   u00111 : constant Version_32 := 16#fdab2bdd#;
   ...
   u00113 : constant Version_32 := 16#538e63fc#;
   ...
   u00120 : constant Version_32 := 16#85ba8cba#;
   ...
   u00123 : constant Version_32 := 16#039168f8#;
   ...
   u00125 : constant Version_32 := 16#8eac1373#;
   pragma Export (C, u00125, "system__compare_array_unsigned_32B");
   u00126 : constant Version_32 := 16#686a6890#;
   pragma Export (C, u00126, "system__compare_array_unsigned_32S");
   ...
   u00138 : constant Version_32 := 16#94123721#;
   pragma Export (C, u00138, "ada__wide_wide_text_io__wide_wide_unbounded_ioS");
   u00139 : constant Version_32 := 16#4566b0d5#;
   pragma Export (C, u00139, "ada__strings__wide_wide_unbounded__wide_wide_text_ioB");
   u00140 : constant Version_32 := 16#74c9f4f5#;
   pragma Export (C, u00140, "ada__strings__wide_wide_unbounded__wide_wide_text_ioS");
   ...
   u00146 : constant Version_32 := 16#a1aa77e1#;
   ...
   u00150 : constant Version_32 := 16#ff2a7423#;
   ...
   --  ada.strings.wide_wide_unbounded.wide_wide_text_io%s
   --  ada.strings.wide_wide_unbounded.wide_wide_text_io%b
   --  ada.wide_wide_text_io.wide_wide_unbounded_io%s
   --  report%s
   --  report%b
   --  cxab005%b
