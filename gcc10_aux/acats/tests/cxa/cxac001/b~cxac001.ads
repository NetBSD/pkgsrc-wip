...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxac001" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#5c9b4c74#;
   pragma Export (C, u00001, "cxac001B");
   ...
   u00126 : constant Version_32 := 16#c059725a#;
