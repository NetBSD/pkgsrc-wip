...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxacb01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#97897332#;
   pragma Export (C, u00001, "cxacb01B");
   ...
   u00116 : constant Version_32 := 16#bca01b78#;
   pragma Export (C, u00116, "fxacb00S");
