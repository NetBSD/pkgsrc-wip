pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxacc01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxacc01.adb");
...
package body ada_main is
   ...
   E116 : Short_Integer; pragma Import (Ada, E116, "fxacc00_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "fxacc00__finalize_spec");
      begin
         E116 := E116 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxacc01");
