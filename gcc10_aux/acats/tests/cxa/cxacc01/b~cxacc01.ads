...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxacc01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#e9ef4694#;
   pragma Export (C, u00001, "cxacc01B");
   ...
   u00116 : constant Version_32 := 16#c3d1501c#;
   pragma Export (C, u00116, "fxacc00S");
