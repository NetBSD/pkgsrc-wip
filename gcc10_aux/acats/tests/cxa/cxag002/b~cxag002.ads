...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxag002" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#04941765#;
   pragma Export (C, u00001, "cxag002B");
   ...
   u00164 : constant Version_32 := 16#74d3cdd6#;
   pragma Export (C, u00164, "impdefB");
   u00165 : constant Version_32 := 16#ba6af773#;
   pragma Export (C, u00165, "impdefS");
   u00166 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00166, "ada__text_ioB");
   u00167 : constant Version_32 := 16#971fad3a#;
