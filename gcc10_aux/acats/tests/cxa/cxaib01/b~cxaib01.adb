pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxaib01.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxaib01.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "cxaib01_data_E");
   E131 : Short_Integer; pragma Import (Ada, E131, "report_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxaib01_data__finalize_spec");
      begin
         E102 := E102 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxaib01");
...
--  BEGIN Object file/option list
   --   /home/fernando/mysandboxfolder/tmp/acats/support/fxaib00.o
   --   ./cxaib01_data.o
