...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaib01" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7a8e8bf2#;
   pragma Export (C, u00001, "cxaib01B");
   ...
   u00102 : constant Version_32 := 16#05bf4ae9#;
   pragma Export (C, u00102, "cxaib01_dataS");
