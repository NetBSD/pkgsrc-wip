...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaib02" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#a66388f4#;
   pragma Export (C, u00001, "cxaib02B");
   ...
   u00102 : constant Version_32 := 16#20104273#;
   pragma Export (C, u00102, "cxaib02_dataS");
