...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxaib03" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6f19fef4#;
   pragma Export (C, u00001, "cxaib03B");
   ...
   u00102 : constant Version_32 := 16#1f6f6e5d#;
   pragma Export (C, u00102, "cxaib03_dataS");
