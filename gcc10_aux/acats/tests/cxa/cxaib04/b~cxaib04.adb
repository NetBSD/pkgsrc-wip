pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxaib04.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxaib04.adb");
...
package body ada_main is
   ...
   E102 : Short_Integer; pragma Import (Ada, E102, "cxaib04_data_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxaib04_data__finalize_spec");
      begin
         E102 := E102 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxaib04");
