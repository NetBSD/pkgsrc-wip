...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxb3009" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#20623464#;
   pragma Export (C, u00001, "cxb3009B");
   ...
   u00100 : constant Version_32 := 16#89941078#;
