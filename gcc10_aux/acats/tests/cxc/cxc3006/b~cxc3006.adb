pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxc3006.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxc3006.adb");
...
package body ada_main is
   ...
   E178 : Short_Integer; pragma Import (Ada, E178, "cxc3006_0_E");
   ...
   E180 : Short_Integer; pragma Import (Ada, E180, "cxc3006_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxc3006_1__finalize_spec");
      begin
         F1;
      end;
      E178 := E178 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "cxc3006_0__finalize_spec");
      begin
         F2;
      end;
      E162 := E162 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxc3006");
