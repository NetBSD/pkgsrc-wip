...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxc3007" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#44c17acd#;
   pragma Export (C, u00001, "cxc3007B");
   ...
   u00005 : constant Version_32 := 16#ec7b5607#;
   pragma Export (C, u00005, "ada__interruptsB");
   u00006 : constant Version_32 := 16#d55d08ae#;
   pragma Export (C, u00006, "ada__interruptsS");
   ...
   u00120 : constant Version_32 := 16#c2216981#;
   pragma Export (C, u00120, "system__taskingB");
   u00121 : constant Version_32 := 16#141170cc#;
   pragma Export (C, u00121, "system__taskingS");
   u00122 : constant Version_32 := 16#6ec3c867#;
   pragma Export (C, u00122, "system__stack_usageB");
   u00123 : constant Version_32 := 16#3a3ac346#;
   pragma Export (C, u00123, "system__stack_usageS");
   u00124 : constant Version_32 := 16#f0965c7b#;
   pragma Export (C, u00124, "system__tasking__debugB");
   u00125 : constant Version_32 := 16#58ee8924#;
   ...
   u00131 : constant Version_32 := 16#c71b14d7#;
   ...
   u00133 : constant Version_32 := 16#b71847c6#;
   pragma Export (C, u00133, "system__img_lliS");
   u00134 : constant Version_32 := 16#eb894f1f#;
   pragma Export (C, u00134, "system__tasking__utilitiesB");
   u00135 : constant Version_32 := 16#0f670827#;
   pragma Export (C, u00135, "system__tasking__utilitiesS");
   ...
   u00157 : constant Version_32 := 16#6b7b2f4e#;
   pragma Export (C, u00157, "system__interruptsB");
   u00158 : constant Version_32 := 16#def7f352#;
   pragma Export (C, u00158, "system__interruptsS");
   u00159 : constant Version_32 := 16#e932e590#;
   pragma Export (C, u00159, "ada__real_timeB");
   u00160 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00160, "ada__real_timeS");
   u00161 : constant Version_32 := 16#1068f06c#;
   pragma Export (C, u00161, "system__interrupt_management__operationsB");
   u00162 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00162, "system__interrupt_management__operationsS");
   u00163 : constant Version_32 := 16#c684e35a#;
   pragma Export (C, u00163, "system__task_primitives__interrupt_operationsB");
   u00164 : constant Version_32 := 16#84a1b9f4#;
   pragma Export (C, u00164, "system__task_primitives__interrupt_operationsS");
   u00165 : constant Version_32 := 16#9322406a#;
   ...
   u00167 : constant Version_32 := 16#69bd1289#;
   ...
   u00169 : constant Version_32 := 16#83c8fb63#;
   ...
   u00171 : constant Version_32 := 16#0780a76b#;
   pragma Export (C, u00171, "system__tasking__stagesB");
   u00172 : constant Version_32 := 16#bfc55b2f#;
   pragma Export (C, u00172, "system__tasking__stagesS");
   u00173 : constant Version_32 := 16#7411c4c3#;
   pragma Export (C, u00173, "cxc3007_0B");
   u00174 : constant Version_32 := 16#466abf38#;
   pragma Export (C, u00174, "cxc3007_0S");
   u00175 : constant Version_32 := 16#74d3cdd6#;
   pragma Export (C, u00175, "impdefB");
   u00176 : constant Version_32 := 16#ba6af773#;
   pragma Export (C, u00176, "impdefS");
   u00177 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00177, "ada__text_ioB");
   u00178 : constant Version_32 := 16#971fad3a#;
   ...
   u00182 : constant Version_32 := 16#0126f372#;
   pragma Export (C, u00182, "system__file_ioS");
   u00183 : constant Version_32 := 16#5bc888bf#;
   pragma Export (C, u00183, "system__file_control_blockS");
   u00184 : constant Version_32 := 16#91d53f4f#;
   pragma Export (C, u00184, "ada__text_io__modular_auxB");
   u00185 : constant Version_32 := 16#9bb2cffe#;
   pragma Export (C, u00185, "ada__text_io__modular_auxS");
   ...
   u00188 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00188, "system__img_biuB");
   u00189 : constant Version_32 := 16#54f3e6d9#;
   pragma Export (C, u00189, "system__img_biuS");
   u00190 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00190, "system__img_llbB");
   u00191 : constant Version_32 := 16#1534f627#;
   pragma Export (C, u00191, "system__img_llbS");
   u00192 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00192, "system__img_lluB");
   u00193 : constant Version_32 := 16#db186e57#;
   pragma Export (C, u00193, "system__img_lluS");
   u00194 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00194, "system__img_llwB");
   u00195 : constant Version_32 := 16#bc58d5b1#;
   pragma Export (C, u00195, "system__img_llwS");
   u00196 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00196, "system__img_wiuB");
   u00197 : constant Version_32 := 16#3ab2614b#;
   pragma Export (C, u00197, "system__img_wiuS");
   u00198 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00198, "system__val_unsB");
   u00199 : constant Version_32 := 16#a7d7132d#;
   pragma Export (C, u00199, "system__val_unsS");
   u00200 : constant Version_32 := 16#92f3335b#;
   pragma Export (C, u00200, "reportB");
   u00201 : constant Version_32 := 16#df19fbea#;
   pragma Export (C, u00201, "reportS");
   u00202 : constant Version_32 := 16#fc54e290#;
   pragma Export (C, u00202, "ada__calendarB");
   u00203 : constant Version_32 := 16#31350a81#;
   pragma Export (C, u00203, "ada__calendarS");
   u00204 : constant Version_32 := 16#0bc72429#;
   pragma Export (C, u00204, "impdef__annex_cB");
   u00205 : constant Version_32 := 16#5a5f4b78#;
   pragma Export (C, u00205, "impdef__annex_cS");
   u00206 : constant Version_32 := 16#357666d8#;
   pragma Export (C, u00206, "ada__calendar__delaysB");
   u00207 : constant Version_32 := 16#d86d2f1d#;
