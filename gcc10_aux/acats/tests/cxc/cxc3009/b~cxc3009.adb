pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxc3009.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxc3009.adb");
...
package body ada_main is
   ...
   E178 : Short_Integer; pragma Import (Ada, E178, "cxc3009_1_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxc3009_1__finalize_spec");
      begin
         F1;
      end;
      E162 := E162 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxc3009");
