pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxc7004.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxc7004.adb");
...
package body ada_main is
   ...
   E103 : Short_Integer; pragma Import (Ada, E103, "cxc7004_0_E");
   ...
   begin
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxc7004_0__finalize_body");
      begin
         E103 := E103 - 1;
         F1;
      end;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxc7004");
