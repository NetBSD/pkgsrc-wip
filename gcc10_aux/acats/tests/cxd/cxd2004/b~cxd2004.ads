...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxd2004" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#9055834d#;
   pragma Export (C, u00001, "cxd2004B");
   ...
   u00168 : constant Version_32 := 16#3b78961b#;
   pragma Export (C, u00168, "impdef__annex_dS");
