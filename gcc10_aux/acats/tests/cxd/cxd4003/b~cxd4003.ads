...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxd4003" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ed0747df#;
   pragma Export (C, u00001, "cxd4003B");
   ...
   u00102 : constant Version_32 := 16#a09ff5e2#;
   pragma Export (C, u00102, "ada__dynamic_prioritiesB");
   u00103 : constant Version_32 := 16#1e71aca7#;
   pragma Export (C, u00103, "ada__dynamic_prioritiesS");
   u00104 : constant Version_32 := 16#d51a3e48#;
   pragma Export (C, u00104, "system__task_primitivesS");
   u00105 : constant Version_32 := 16#bfbf116d#;
   pragma Export (C, u00105, "system__os_interfaceB");
   u00106 : constant Version_32 := 16#7baac831#;
   pragma Export (C, u00106, "system__os_interfaceS");
   u00107 : constant Version_32 := 16#7017a763#;
   pragma Export (C, u00107, "system__task_primitives__operationsB");
   u00108 : constant Version_32 := 16#9fa58b20#;
   ...
   u00110 : constant Version_32 := 16#328bf158#;
   ...
   u00112 : constant Version_32 := 16#9efb8d64#;
   pragma Export (C, u00112, "system__multiprocessorsS");
   u00113 : constant Version_32 := 16#7d4d4c1d#;
   pragma Export (C, u00113, "system__os_constantsS");
   u00114 : constant Version_32 := 16#e0fce7f8#;
   pragma Export (C, u00114, "system__task_infoB");
   u00115 : constant Version_32 := 16#264daf16#;
   pragma Export (C, u00115, "system__task_infoS");
   u00116 : constant Version_32 := 16#c2216981#;
   pragma Export (C, u00116, "system__taskingB");
   u00117 : constant Version_32 := 16#141170cc#;
   pragma Export (C, u00117, "system__taskingS");
   u00118 : constant Version_32 := 16#6ec3c867#;
   pragma Export (C, u00118, "system__stack_usageB");
   u00119 : constant Version_32 := 16#3a3ac346#;
   pragma Export (C, u00119, "system__stack_usageS");
   u00120 : constant Version_32 := 16#f0965c7b#;
   pragma Export (C, u00120, "system__tasking__debugB");
   u00121 : constant Version_32 := 16#58ee8924#;
   ...
   u00127 : constant Version_32 := 16#c71b14d7#;
   ...
   u00129 : constant Version_32 := 16#b71847c6#;
   pragma Export (C, u00129, "system__img_lliS");
   u00130 : constant Version_32 := 16#b1acf821#;
   pragma Export (C, u00130, "ada__task_identificationB");
   u00131 : constant Version_32 := 16#691a3ea2#;
   pragma Export (C, u00131, "ada__task_identificationS");
   u00132 : constant Version_32 := 16#eb894f1f#;
   pragma Export (C, u00132, "system__tasking__utilitiesB");
   u00133 : constant Version_32 := 16#0f670827#;
   pragma Export (C, u00133, "system__tasking__utilitiesS");
   u00134 : constant Version_32 := 16#5d91da9f#;
   ...
   u00161 : constant Version_32 := 16#e932e590#;
   pragma Export (C, u00161, "ada__real_timeB");
   u00162 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00162, "ada__real_timeS");
   u00163 : constant Version_32 := 16#74d3cdd6#;
   pragma Export (C, u00163, "impdefB");
   u00164 : constant Version_32 := 16#ba6af773#;
   pragma Export (C, u00164, "impdefS");
   u00165 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00165, "ada__text_ioB");
   u00166 : constant Version_32 := 16#971fad3a#;
   pragma Export (C, u00166, "ada__text_ioS");
   u00167 : constant Version_32 := 16#73d2d764#;
   pragma Export (C, u00167, "interfaces__c_streamsB");
   u00168 : constant Version_32 := 16#b1330297#;
   pragma Export (C, u00168, "interfaces__c_streamsS");
   u00169 : constant Version_32 := 16#ec9c64c3#;
   pragma Export (C, u00169, "system__file_ioB");
   u00170 : constant Version_32 := 16#0126f372#;
   pragma Export (C, u00170, "system__file_ioS");
   u00171 : constant Version_32 := 16#5bc888bf#;
   pragma Export (C, u00171, "system__file_control_blockS");
   u00172 : constant Version_32 := 16#91d53f4f#;
   pragma Export (C, u00172, "ada__text_io__modular_auxB");
   u00173 : constant Version_32 := 16#9bb2cffe#;
   pragma Export (C, u00173, "ada__text_io__modular_auxS");
   u00174 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00174, "ada__text_io__generic_auxB");
   u00175 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00175, "ada__text_io__generic_auxS");
   u00176 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00176, "system__img_biuB");
   u00177 : constant Version_32 := 16#54f3e6d9#;
   pragma Export (C, u00177, "system__img_biuS");
   u00178 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00178, "system__img_llbB");
   u00179 : constant Version_32 := 16#1534f627#;
   pragma Export (C, u00179, "system__img_llbS");
   u00180 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00180, "system__img_lluB");
   u00181 : constant Version_32 := 16#db186e57#;
   pragma Export (C, u00181, "system__img_lluS");
   u00182 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00182, "system__img_llwB");
   u00183 : constant Version_32 := 16#bc58d5b1#;
   pragma Export (C, u00183, "system__img_llwS");
   u00184 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00184, "system__img_wiuB");
   u00185 : constant Version_32 := 16#3ab2614b#;
   pragma Export (C, u00185, "system__img_wiuS");
   u00186 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00186, "system__val_unsB");
   u00187 : constant Version_32 := 16#a7d7132d#;
   pragma Export (C, u00187, "system__val_unsS");
   u00188 : constant Version_32 := 16#92f3335b#;
   pragma Export (C, u00188, "reportB");
   u00189 : constant Version_32 := 16#df19fbea#;
   pragma Export (C, u00189, "reportS");
   u00190 : constant Version_32 := 16#9322406a#;
   ...
   u00192 : constant Version_32 := 16#69bd1289#;
   ...
   u00194 : constant Version_32 := 16#83c8fb63#;
   ...
   u00196 : constant Version_32 := 16#0780a76b#;
   pragma Export (C, u00196, "system__tasking__stagesB");
   u00197 : constant Version_32 := 16#bfc55b2f#;
   ...
   u00199 : constant Version_32 := 16#ff2a7423#;
