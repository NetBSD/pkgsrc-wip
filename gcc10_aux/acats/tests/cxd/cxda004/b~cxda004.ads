...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxda004" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#f9f1da29#;
   pragma Export (C, u00001, "cxda004B");
   ...
   u00102 : constant Version_32 := 16#ec7b5607#;
   pragma Export (C, u00102, "ada__interruptsB");
   u00103 : constant Version_32 := 16#d55d08ae#;
   pragma Export (C, u00103, "ada__interruptsS");
   ...
   u00110 : constant Version_32 := 16#b1acf821#;
   pragma Export (C, u00110, "ada__task_identificationB");
   u00111 : constant Version_32 := 16#691a3ea2#;
   pragma Export (C, u00111, "ada__task_identificationS");
   u00112 : constant Version_32 := 16#d51a3e48#;
   pragma Export (C, u00112, "system__task_primitivesS");
   u00113 : constant Version_32 := 16#bfbf116d#;
   pragma Export (C, u00113, "system__os_interfaceB");
   u00114 : constant Version_32 := 16#7baac831#;
   pragma Export (C, u00114, "system__os_interfaceS");
   u00115 : constant Version_32 := 16#7017a763#;
   pragma Export (C, u00115, "system__task_primitives__operationsB");
   u00116 : constant Version_32 := 16#9fa58b20#;
   ...
   u00118 : constant Version_32 := 16#328bf158#;
   ...
   u00120 : constant Version_32 := 16#9efb8d64#;
   pragma Export (C, u00120, "system__multiprocessorsS");
   u00121 : constant Version_32 := 16#7d4d4c1d#;
   pragma Export (C, u00121, "system__os_constantsS");
   u00122 : constant Version_32 := 16#e0fce7f8#;
   pragma Export (C, u00122, "system__task_infoB");
   u00123 : constant Version_32 := 16#264daf16#;
   pragma Export (C, u00123, "system__task_infoS");
   u00124 : constant Version_32 := 16#c2216981#;
   pragma Export (C, u00124, "system__taskingB");
   u00125 : constant Version_32 := 16#141170cc#;
   pragma Export (C, u00125, "system__taskingS");
   u00126 : constant Version_32 := 16#6ec3c867#;
   ...
   u00128 : constant Version_32 := 16#f0965c7b#;
   pragma Export (C, u00128, "system__tasking__debugB");
   u00129 : constant Version_32 := 16#58ee8924#;
   ...
   u00135 : constant Version_32 := 16#c71b14d7#;
   ...
   u00137 : constant Version_32 := 16#b71847c6#;
   pragma Export (C, u00137, "system__img_lliS");
   u00138 : constant Version_32 := 16#eb894f1f#;
   pragma Export (C, u00138, "system__tasking__utilitiesB");
   u00139 : constant Version_32 := 16#0f670827#;
   pragma Export (C, u00139, "system__tasking__utilitiesS");
   u00140 : constant Version_32 := 16#4e315ff7#;
   pragma Export (C, u00140, "system__tasking__initializationB");
   u00141 : constant Version_32 := 16#fc2303e6#;
   pragma Export (C, u00141, "system__tasking__initializationS");
   u00142 : constant Version_32 := 16#55e88911#;
   pragma Export (C, u00142, "system__soft_links__taskingB");
   u00143 : constant Version_32 := 16#e939497e#;
   pragma Export (C, u00143, "system__soft_links__taskingS");
   u00144 : constant Version_32 := 16#3880736e#;
   pragma Export (C, u00144, "ada__exceptions__is_null_occurrenceB");
   u00145 : constant Version_32 := 16#6fde25af#;
   pragma Export (C, u00145, "ada__exceptions__is_null_occurrenceS");
   u00146 : constant Version_32 := 16#263e126a#;
   pragma Export (C, u00146, "system__tasking__task_attributesB");
   u00147 : constant Version_32 := 16#4c97674c#;
   pragma Export (C, u00147, "system__tasking__task_attributesS");
   u00148 : constant Version_32 := 16#cee82bbd#;
   pragma Export (C, u00148, "system__tasking__queuingB");
   u00149 : constant Version_32 := 16#6dba2805#;
   pragma Export (C, u00149, "system__tasking__queuingS");
   u00150 : constant Version_32 := 16#7f6ff536#;
   pragma Export (C, u00150, "system__tasking__protected_objectsB");
   u00151 : constant Version_32 := 16#15001baf#;
   ...
   u00155 : constant Version_32 := 16#ed25cb46#;
   ...
   u00157 : constant Version_32 := 16#10558b11#;
   pragma Export (C, u00157, "ada__streamsB");
   u00158 : constant Version_32 := 16#67e31212#;
   pragma Export (C, u00158, "ada__streamsS");
   u00159 : constant Version_32 := 16#95817ed8#;
   pragma Export (C, u00159, "system__finalization_rootB");
   u00160 : constant Version_32 := 16#e9a56187#;
   pragma Export (C, u00160, "system__finalization_rootS");
   u00161 : constant Version_32 := 16#6b7b2f4e#;
   pragma Export (C, u00161, "system__interruptsB");
   u00162 : constant Version_32 := 16#def7f352#;
   pragma Export (C, u00162, "system__interruptsS");
   u00163 : constant Version_32 := 16#e932e590#;
   pragma Export (C, u00163, "ada__real_timeB");
   u00164 : constant Version_32 := 16#69ea8064#;
   pragma Export (C, u00164, "ada__real_timeS");
   u00165 : constant Version_32 := 16#1068f06c#;
   pragma Export (C, u00165, "system__interrupt_management__operationsB");
   u00166 : constant Version_32 := 16#19b909c9#;
   pragma Export (C, u00166, "system__interrupt_management__operationsS");
   u00167 : constant Version_32 := 16#c684e35a#;
   pragma Export (C, u00167, "system__task_primitives__interrupt_operationsB");
   u00168 : constant Version_32 := 16#84a1b9f4#;
   pragma Export (C, u00168, "system__task_primitives__interrupt_operationsS");
   ...
   u00171 : constant Version_32 := 16#69bd1289#;
   ...
   u00173 : constant Version_32 := 16#83c8fb63#;
   ...
   u00175 : constant Version_32 := 16#0780a76b#;
   pragma Export (C, u00175, "system__tasking__stagesB");
   u00176 : constant Version_32 := 16#bfc55b2f#;
   pragma Export (C, u00176, "system__tasking__stagesS");
   u00177 : constant Version_32 := 16#5f029508#;
   pragma Export (C, u00177, "ada__synchronous_task_controlB");
   u00178 : constant Version_32 := 16#241197a3#;
   pragma Export (C, u00178, "ada__synchronous_task_controlS");
   u00179 : constant Version_32 := 16#52b65196#;
   pragma Export (C, u00179, "cxda004_1B");
   u00180 : constant Version_32 := 16#a9b42d73#;
   pragma Export (C, u00180, "cxda004_1S");
   u00181 : constant Version_32 := 16#74d3cdd6#;
   pragma Export (C, u00181, "impdefB");
   u00182 : constant Version_32 := 16#ba6af773#;
   pragma Export (C, u00182, "impdefS");
   u00183 : constant Version_32 := 16#f4e097a7#;
   pragma Export (C, u00183, "ada__text_ioB");
   u00184 : constant Version_32 := 16#971fad3a#;
   ...
   u00188 : constant Version_32 := 16#0126f372#;
   pragma Export (C, u00188, "system__file_ioS");
   u00189 : constant Version_32 := 16#5bc888bf#;
   pragma Export (C, u00189, "system__file_control_blockS");
   u00190 : constant Version_32 := 16#91d53f4f#;
   pragma Export (C, u00190, "ada__text_io__modular_auxB");
   u00191 : constant Version_32 := 16#9bb2cffe#;
   pragma Export (C, u00191, "ada__text_io__modular_auxS");
   u00192 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00192, "ada__text_io__generic_auxB");
   u00193 : constant Version_32 := 16#305a076a#;
   pragma Export (C, u00193, "ada__text_io__generic_auxS");
   u00194 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00194, "system__img_biuB");
   u00195 : constant Version_32 := 16#54f3e6d9#;
   pragma Export (C, u00195, "system__img_biuS");
   u00196 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00196, "system__img_llbB");
   u00197 : constant Version_32 := 16#1534f627#;
   pragma Export (C, u00197, "system__img_llbS");
   u00198 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00198, "system__img_lluB");
   u00199 : constant Version_32 := 16#db186e57#;
   pragma Export (C, u00199, "system__img_lluS");
   u00200 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00200, "system__img_llwB");
   u00201 : constant Version_32 := 16#bc58d5b1#;
   pragma Export (C, u00201, "system__img_llwS");
   u00202 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00202, "system__img_wiuB");
   u00203 : constant Version_32 := 16#3ab2614b#;
   pragma Export (C, u00203, "system__img_wiuS");
   u00204 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00204, "system__val_unsB");
   u00205 : constant Version_32 := 16#a7d7132d#;
   pragma Export (C, u00205, "system__val_unsS");
   u00206 : constant Version_32 := 16#92f3335b#;
   pragma Export (C, u00206, "reportB");
   u00207 : constant Version_32 := 16#df19fbea#;
   pragma Export (C, u00207, "reportS");
   u00208 : constant Version_32 := 16#0bc72429#;
   pragma Export (C, u00208, "impdef__annex_cB");
   u00209 : constant Version_32 := 16#5a5f4b78#;
   pragma Export (C, u00209, "impdef__annex_cS");
   ...
   u00212 : constant Version_32 := 16#c65fdedb#;
   pragma Export (C, u00212, "ada__interrupts__namesS");
   u00213 : constant Version_32 := 16#e31b7c4e#;
   pragma Export (C, u00213, "system__memoryB");
   u00214 : constant Version_32 := 16#ff2a7423#;
