...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxf3002" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#dac63d15#;
   pragma Export (C, u00001, "cxf3002B");
   ...
   u00102 : constant Version_32 := 16#0864f341#;
   pragma Export (C, u00102, "ada__wide_text_ioB");
   u00103 : constant Version_32 := 16#d34a0cce#;
   ...
   u00114 : constant Version_32 := 16#45d30eb5#;
   pragma Export (C, u00114, "ada__wide_text_io__editingB");
   u00115 : constant Version_32 := 16#f08a44ff#;
   pragma Export (C, u00115, "ada__wide_text_io__editingS");
   u00116 : constant Version_32 := 16#bf363ed2#;
   ...
   u00118 : constant Version_32 := 16#80b8f781#;
   ...
   u00120 : constant Version_32 := 16#bc438ed0#;
   pragma Export (C, u00120, "ada__strings__wide_fixedB");
   u00121 : constant Version_32 := 16#412537cd#;
   pragma Export (C, u00121, "ada__strings__wide_fixedS");
   u00122 : constant Version_32 := 16#44686e0b#;
   pragma Export (C, u00122, "ada__strings__wide_mapsB");
   u00123 : constant Version_32 := 16#26451250#;
   pragma Export (C, u00123, "ada__strings__wide_mapsS");
   ...
   u00136 : constant Version_32 := 16#a4ee556b#;
   pragma Export (C, u00136, "ada__strings__wide_searchB");
   u00137 : constant Version_32 := 16#1748eeac#;
   pragma Export (C, u00137, "ada__strings__wide_searchS");
   ...
   --  ada.wide_text_io%s
   --  ada.wide_text_io%b
   --  ada.wide_text_io.editing%s
   --  ada.wide_text_io.editing%b
   --  report%s
   --  report%b
   --  cxf3002%b
