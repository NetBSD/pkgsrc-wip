...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxf3a05" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#41942e86#;
   pragma Export (C, u00001, "cxf3a05B");
