pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxf3a07.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxf3a07.adb");
...
package body ada_main is
   ...
   E119 : Short_Integer; pragma Import (Ada, E119, "ada__text_io__editing_E");
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxf3a07");
