...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_cxg2005" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#827d2b3a#;
   pragma Export (C, u00001, "cxg2005B");
   ...
   u00121 : constant Version_32 := 16#1a29a9cb#;
