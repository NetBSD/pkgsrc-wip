pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b~cxh3001.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b~cxh3001.adb");
...
package body ada_main is
   ...
   E109 : Short_Integer; pragma Import (Ada, E109, "cxh3001_0_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "cxh3001_0__finalize_spec");
      begin
         F1;
      end;
      E157 := E157 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_cxh3001");
