...
BUILDLINK_FILES.gnatcoll-bindings=	include/gnatcoll_*/* lib/gnatcoll* lib/gnatcoll_*/*
...
BUILDLINK_CONTENTS_FILTER.gnatcoll-bindings=	\
	${EGREP} '(include/.*\.ads$$|lib/.*\.ali$$|lib/.*\.a$$|lib/gnatcoll.*\.so$$|share/gpr/manifests/.*|share/gpr/.*\.gpr)'
