...
CARGO_CRATE_DEPENDS+=	derive-where-1.2.7
...
CARGO_CRATE_DEPENDS+=	phonenumber-0.3.6+8.13.36
...
CARGO_CRATE_DEPENDS+=	pqcrypto-internals-0.2.7
CARGO_CRATE_DEPENDS+=	pqcrypto-kyber-0.7.9
CARGO_CRATE_DEPENDS+=	pqcrypto-traits-0.3.5
#CARGO_CRATE_DEPENDS+=	presage-0.7.0-dev
#CARGO_CRATE_DEPENDS+=	presage-store-sqlite-0.1.0
...
CARGO_CRATE_DEPENDS+=	prost-build-0.13.4
