...
CARGO_CRATE_DEPENDS+=	embed-resource-3.0.11
...
CARGO_CRATE_DEPENDS+=	muda-0.19.3
...
CARGO_CRATE_DEPENDS+=	proc-macro-crate-2.0.2
...
CARGO_CRATE_DEPENDS+=	tao-0.35.3
CARGO_CRATE_DEPENDS+=	tao-macros-0.1.4
CARGO_CRATE_DEPENDS+=	tar-0.4.46
CARGO_CRATE_DEPENDS+=	target-lexicon-0.12.16
CARGO_CRATE_DEPENDS+=	tauri-2.11.5
CARGO_CRATE_DEPENDS+=	tauri-build-2.6.3
CARGO_CRATE_DEPENDS+=	tauri-codegen-2.6.3
CARGO_CRATE_DEPENDS+=	tauri-macros-2.6.3
CARGO_CRATE_DEPENDS+=	tauri-plugin-2.6.3
...
CARGO_CRATE_DEPENDS+=	tauri-runtime-2.11.3
CARGO_CRATE_DEPENDS+=	tauri-runtime-wry-2.11.4
CARGO_CRATE_DEPENDS+=	tauri-utils-2.9.3
...
CARGO_CRATE_DEPENDS+=	tray-icon-0.24.2
...
CARGO_CRATE_DEPENDS+=	wgpu-core-deps-wasm-29.0.4
...
CARGO_CRATE_DEPENDS+=	zvariant-5.14.0
CARGO_CRATE_DEPENDS+=	zvariant_derive-5.14.0
CARGO_CRATE_DEPENDS+=	zvariant_utils-4.0.0
