...
CXXFLAGS="${CPPFLAGS} ${CXXFLAGS} ${PTHREAD_CFLAGS} -c -g -D_DEBUG -D_GNU_SOURCE -DENABLE_BINRELOC -I . -D_FILE_OFFSET_BITS=64 -D_PREFIX=\"${PREFIX}\" -D_LIBDIR=\"${PREFIX}/share\" `pkg-config --cflags libglade-2.0 gthread-2.0`"
