...
GO_MODULE_FILES+=	cloud.google.com/go/@v/v0.119.0.mod
GO_MODULE_FILES+=	cloud.google.com/go/@v/v0.119.0.zip
...
GO_MODULE_FILES+=	cloud.google.com/go/bigtable/@v/v1.35.0.mod
GO_MODULE_FILES+=	cloud.google.com/go/bigtable/@v/v1.35.0.zip
...
GO_MODULE_FILES+=	cloud.google.com/go/longrunning/@v/v0.6.5.mod
GO_MODULE_FILES+=	cloud.google.com/go/longrunning/@v/v0.6.5.zip
...
GO_MODULE_FILES+=	cloud.google.com/go/pubsub/@v/v1.48.0.mod
GO_MODULE_FILES+=	cloud.google.com/go/pubsub/@v/v1.48.0.zip
...
GO_MODULE_FILES+=	github.com/!data!dog/sketches-go/@v/v1.4.7.mod
GO_MODULE_FILES+=	github.com/!data!dog/sketches-go/@v/v1.4.7.zip
...
GO_MODULE_FILES+=	github.com/!i!b!m/go-sdk-core/v5/@v/v5.19.0.mod
GO_MODULE_FILES+=	github.com/!i!b!m/go-sdk-core/v5/@v/v5.19.0.zip
GO_MODULE_FILES+=	github.com/!i!b!m/ibm-cos-sdk-go/@v/v1.12.2.mod
GO_MODULE_FILES+=	github.com/!i!b!m/ibm-cos-sdk-go/@v/v1.12.2.zip
...
GO_MODULE_FILES+=	github.com/!massless!particle/azure-storage-blob-go/@v/v0.14.1-0.20240322194317-344980fda573.mod
GO_MODULE_FILES+=	github.com/!massless!particle/azure-storage-blob-go/@v/v0.14.1-0.20240322194317-344980fda573.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/@v/v1.36.2.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/@v/v1.36.2.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/config/@v/v1.29.6.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/config/@v/v1.29.6.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/credentials/@v/v1.17.59.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/credentials/@v/v1.17.59.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/feature/ec2/imds/@v/v1.16.28.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/feature/ec2/imds/@v/v1.16.28.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/configsources/@v/v1.3.33.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/configsources/@v/v1.3.33.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/endpoints/v2/@v/v2.6.33.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/internal/endpoints/v2/@v/v2.6.33.zip
...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/internal/presigned-url/@v/v1.12.14.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/internal/presigned-url/@v/v1.12.14.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sso/@v/v1.24.15.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sso/@v/v1.24.15.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/ssooidc/@v/v1.28.14.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/ssooidc/@v/v1.28.14.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sts/@v/v1.33.14.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go-v2/service/sts/@v/v1.33.14.zip
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.27.0.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.38.35.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.55.6.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.55.6.zip
GO_MODULE_FILES+=	github.com/aws/smithy-go/@v/v1.22.3.mod
GO_MODULE_FILES+=	github.com/aws/smithy-go/@v/v1.22.3.zip
GO_MODULE_FILES+=	github.com/axiomhq/hyperloglog/@v/v0.2.5.mod
GO_MODULE_FILES+=	github.com/axiomhq/hyperloglog/@v/v0.2.5.zip
...
GO_MODULE_FILES+=	github.com/baidubce/bce-sdk-go/@v/v0.9.222.mod
GO_MODULE_FILES+=	github.com/baidubce/bce-sdk-go/@v/v0.9.222.zip
...
GO_MODULE_FILES+=	github.com/coder/quartz/@v/v0.1.3.mod
GO_MODULE_FILES+=	github.com/coder/quartz/@v/v0.1.3.zip
GO_MODULE_FILES+=	github.com/containerd/containerd/v2/@v/v2.0.5.mod
GO_MODULE_FILES+=	github.com/containerd/containerd/v2/@v/v2.0.5.zip
...
GO_MODULE_FILES+=	github.com/digitalocean/godo/@v/v1.132.0.mod
GO_MODULE_FILES+=	github.com/digitalocean/godo/@v/v1.132.0.zip
...
GO_MODULE_FILES+=	github.com/go-playground/validator/v10/@v/v10.24.0.mod
GO_MODULE_FILES+=	github.com/go-playground/validator/v10/@v/v10.24.0.zip
...
GO_MODULE_FILES+=	github.com/gophercloud/gophercloud/v2/@v/v2.4.0.mod
GO_MODULE_FILES+=	github.com/gophercloud/gophercloud/v2/@v/v2.4.0.zip
...
GO_MODULE_FILES+=	github.com/grafana/ckit/@v/v0.0.0-20250226083311-4f9f4aacabb5.mod
GO_MODULE_FILES+=	github.com/grafana/ckit/@v/v0.0.0-20250226083311-4f9f4aacabb5.zip
...
GO_MODULE_FILES+=	github.com/grafana/dskit/@v/v0.0.0-20250317084829-9cdd36a91f10.mod
GO_MODULE_FILES+=	github.com/grafana/dskit/@v/v0.0.0-20250317084829-9cdd36a91f10.zip
...
GO_MODULE_FILES+=	github.com/grafana/gomemcache/@v/v0.0.0-20250228145437-da7b95fd2ac1.mod
GO_MODULE_FILES+=	github.com/grafana/gomemcache/@v/v0.0.0-20250228145437-da7b95fd2ac1.zip
...
GO_MODULE_FILES+=	github.com/grafana/objstore/@v/v0.0.0-20250210100727-533688b5600d.mod
GO_MODULE_FILES+=	github.com/grafana/objstore/@v/v0.0.0-20250210100727-533688b5600d.zip
...
GO_MODULE_FILES+=	github.com/grpc-ecosystem/go-grpc-middleware/v2/@v/v2.3.1.mod
GO_MODULE_FILES+=	github.com/grpc-ecosystem/go-grpc-middleware/v2/@v/v2.3.1.zip
...
GO_MODULE_FILES+=	github.com/heroku/x/@v/v0.4.3.mod
GO_MODULE_FILES+=	github.com/heroku/x/@v/v0.4.3.zip
...
GO_MODULE_FILES+=	github.com/influxdata/telegraf/@v/v1.34.1.mod
GO_MODULE_FILES+=	github.com/influxdata/telegraf/@v/v1.34.1.zip
...
GO_MODULE_FILES+=	github.com/kamstrup/intmap/@v/v0.5.1.mod
GO_MODULE_FILES+=	github.com/kamstrup/intmap/@v/v0.5.1.zip
...
GO_MODULE_FILES+=	github.com/leodido/go-syslog/v4/@v/v4.2.0.mod
GO_MODULE_FILES+=	github.com/leodido/go-syslog/v4/@v/v4.2.0.zip
...
GO_MODULE_FILES+=	github.com/mitchellh/mapstructure/@v/v1.5.1-0.20220423185008-bf980b35cac4.mod
GO_MODULE_FILES+=	github.com/mitchellh/mapstructure/@v/v1.5.1-0.20220423185008-bf980b35cac4.zip
...
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/internal/exp/metrics/@v/v0.116.0.mod
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/internal/exp/metrics/@v/v0.116.0.zip
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil/@v/v0.116.0.mod
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil/@v/v0.116.0.zip
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatocumulativeprocessor/@v/v0.116.0.mod
GO_MODULE_FILES+=	github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatocumulativeprocessor/@v/v0.116.0.zip
...
GO_MODULE_FILES+=	github.com/opentracing-contrib/go-stdlib/@v/v1.1.0.mod
GO_MODULE_FILES+=	github.com/opentracing-contrib/go-stdlib/@v/v1.1.0.zip
...
GO_MODULE_FILES+=	github.com/parquet-go/parquet-go/@v/v0.25.0.mod
GO_MODULE_FILES+=	github.com/parquet-go/parquet-go/@v/v0.25.0.zip
...
GO_MODULE_FILES+=	github.com/prometheus/prometheus/@v/v0.302.1.mod
GO_MODULE_FILES+=	github.com/prometheus/prometheus/@v/v0.302.1.zip
...
GO_MODULE_FILES+=	github.com/schollz/progressbar/v3/@v/v3.18.0.mod
GO_MODULE_FILES+=	github.com/schollz/progressbar/v3/@v/v3.18.0.zip
...
GO_MODULE_FILES+=	github.com/shirou/gopsutil/v4/@v/v4.25.2.mod
GO_MODULE_FILES+=	github.com/shirou/gopsutil/v4/@v/v4.25.2.zip
...
GO_MODULE_FILES+=	github.com/sony/gobreaker/v2/@v/v2.1.0.mod
GO_MODULE_FILES+=	github.com/sony/gobreaker/v2/@v/v2.1.0.zip
...
GO_MODULE_FILES+=	github.com/tjhop/slog-gokit/@v/v0.1.4.mod
GO_MODULE_FILES+=	github.com/tjhop/slog-gokit/@v/v0.1.4.zip
...
GO_MODULE_FILES+=	github.com/twmb/franz-go/pkg/kadm/@v/v1.15.0.mod
GO_MODULE_FILES+=	github.com/twmb/franz-go/pkg/kadm/@v/v1.15.0.zip
GO_MODULE_FILES+=	github.com/twmb/franz-go/pkg/kfake/@v/v0.0.0-20241015013301-cea7aa5d8037.mod
GO_MODULE_FILES+=	github.com/twmb/franz-go/pkg/kfake/@v/v0.0.0-20241015013301-cea7aa5d8037.zip
...
GO_MODULE_FILES+=	go.mongodb.org/mongo-driver/@v/v1.17.2.mod
GO_MODULE_FILES+=	go.mongodb.org/mongo-driver/@v/v1.17.2.zip
...
GO_MODULE_FILES+=	go.opentelemetry.io/collector/component/@v/v0.118.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/component/@v/v0.118.0.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/config/configtelemetry/@v/v0.118.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/config/configtelemetry/@v/v0.118.0.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/consumer/@v/v1.24.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/consumer/@v/v1.24.0.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/pdata/@v/v1.28.1.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/pdata/@v/v1.28.1.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/pipeline/@v/v0.118.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/pipeline/@v/v0.118.0.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/processor/@v/v0.118.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/processor/@v/v0.118.0.zip
GO_MODULE_FILES+=	go.opentelemetry.io/collector/semconv/@v/v0.118.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/collector/semconv/@v/v0.118.0.zip
...
GO_MODULE_FILES+=	go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace/@v/v0.59.0.mod
GO_MODULE_FILES+=	go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace/@v/v0.59.0.zip
...
GO_MODULE_FILES+=	k8s.io/client-go/@v/v0.32.1.mod
GO_MODULE_FILES+=	k8s.io/client-go/@v/v0.32.1.zip
...
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20241210054802-24370beab758.mod
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20241210054802-24370beab758.zip
GO_MODULE_FILES+=	modernc.org/libc/@v/v1.61.13.mod
GO_MODULE_FILES+=	modernc.org/libc/@v/v1.61.13.zip
GO_MODULE_FILES+=	modernc.org/mathutil/@v/v1.7.1.mod
GO_MODULE_FILES+=	modernc.org/mathutil/@v/v1.7.1.zip
GO_MODULE_FILES+=	modernc.org/memory/@v/v1.8.2.mod
GO_MODULE_FILES+=	modernc.org/memory/@v/v1.8.2.zip
GO_MODULE_FILES+=	modernc.org/sqlite/@v/v1.36.0.mod
GO_MODULE_FILES+=	modernc.org/sqlite/@v/v1.36.0.zip
...
GO_MODULE_FILES+=	zombiezen.com/go/sqlite/@v/v1.4.0.mod
GO_MODULE_FILES+=	zombiezen.com/go/sqlite/@v/v1.4.0.zip
