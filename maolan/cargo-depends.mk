...
CARGO_CRATE_DEPENDS+=	aotuv_lancer_vorbis_sys-0.1.5
...
CARGO_CRATE_DEPENDS+=	asio-sys-0.2.6
...
CARGO_CRATE_DEPENDS+=	com-scrape-types-0.1.1
...
CARGO_CRATE_DEPENDS+=	coremidi-0.7.0
CARGO_CRATE_DEPENDS+=	coremidi-0.8.0
CARGO_CRATE_DEPENDS+=	coremidi-sys-3.2.0
...
CARGO_CRATE_DEPENDS+=	dasp_frame-0.11.0
...
CARGO_CRATE_DEPENDS+=	ebur128-0.1.10
...
CARGO_CRATE_DEPENDS+=	flacenc-0.5.1
...
CARGO_CRATE_DEPENDS+=	lilv-0.2.4
CARGO_CRATE_DEPENDS+=	lilv-sys-0.2.1
...
CARGO_CRATE_DEPENDS+=	midir-0.10.3
CARGO_CRATE_DEPENDS+=	midly-0.5.3
...
CARGO_CRATE_DEPENDS+=	mp3lame-encoder-0.2.2
CARGO_CRATE_DEPENDS+=	mp3lame-sys-0.1.11
...
CARGO_CRATE_DEPENDS+=	nvtree-0.0.2
...
CARGO_CRATE_DEPENDS+=	ogg_next_sys-0.1.4
...
CARGO_CRATE_DEPENDS+=	parse_cfg-4.1.1
...
CARGO_CRATE_DEPENDS+=	realfft-3.5.0
...
CARGO_CRATE_DEPENDS+=	rubato-0.16.2
...
CARGO_CRATE_DEPENDS+=	symphonia-format-caf-0.5.5
...
CARGO_CRATE_DEPENDS+=	vorbis_rs-0.5.5
CARGO_CRATE_DEPENDS+=	vst3-0.3.0
...
CARGO_CRATE_DEPENDS+=	wasm-bindgen-futures-0.4.62
...
CARGO_CRATE_DEPENDS+=	wavers-1.5.1
