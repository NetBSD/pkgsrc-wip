...
--- src/unix/debugUnix.c.orig	2026-08-01 09:47:22.597934814 +0000
+++ src/unix/debugUnix.c
@@ -23,6 +23,12 @@
...
+
 ...
 # include <execinfo.h>
 #endif
@@ -275,6 +281,20 @@ void * printRegisterState(ucontext_t *uap, FILE* outpu
...
+	return (void *)regs[_REG_RIP];
 	...
 	fprintf_impl(output,
@@ -481,6 +501,9 @@ void reportStackState(const char *msg, char *date, int
