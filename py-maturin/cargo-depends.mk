...
CARGO_CRATE_DEPENDS+=	cargo-options-0.3.1
CARGO_CRATE_DEPENDS+=	cargo-platform-0.1.2
CARGO_CRATE_DEPENDS+=	cargo-xwin-0.10.2
CARGO_CRATE_DEPENDS+=	cargo-zigbuild-0.12.3
...
CARGO_CRATE_DEPENDS+=	fs-err-2.8.1
...
CARGO_CRATE_DEPENDS+=	indicatif-0.17.0-rc.6
...
CARGO_CRATE_DEPENDS+=	lddtree-0.3.1
...
CARGO_CRATE_DEPENDS+=	minijinja-0.20.0
...
CARGO_CRATE_DEPENDS+=	platform-info-1.0.0
...
CARGO_CRATE_DEPENDS+=	uuid-1.2.0
...
CARGO_CRATE_DEPENDS+=	xwin-0.2.5
