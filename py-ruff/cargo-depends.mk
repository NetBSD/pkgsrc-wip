...
CARGO_CRATE_DEPENDS+=	argfile-0.1.5
...
CARGO_CRATE_DEPENDS+=	imperative-1.0.4
...
CARGO_CRATE_DEPENDS+=	is-macro-0.2.2
...
CARGO_CRATE_DEPENDS+=	lalrpop-0.19.9
CARGO_CRATE_DEPENDS+=	lalrpop-util-0.19.9
...
#CARGO_CRATE_DEPENDS+=	libcst-0.1.0
#CARGO_CRATE_DEPENDS+=	libcst_derive-0.1.0
CARGO_CRATE_DEPENDS+=	libmimalloc-sys-0.1.32
...
CARGO_CRATE_DEPENDS+=	mimalloc-0.1.36
...
CARGO_CRATE_DEPENDS+=	pep440_rs-0.3.5
...
CARGO_CRATE_DEPENDS+=	quick-junit-0.3.2
...
CARGO_CRATE_DEPENDS+=	rustpython-ast-0.2.0
CARGO_CRATE_DEPENDS+=	rustpython-common-0.2.0
CARGO_CRATE_DEPENDS+=	rustpython-compiler-core-0.2.0
CARGO_CRATE_DEPENDS+=	rustpython-parser-0.2.0
...
CARGO_CRATE_DEPENDS+=	volatile-0.3.0
