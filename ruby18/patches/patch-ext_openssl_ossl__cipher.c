...
@@ -188,7 +188,7 @@ ossl_cipher_init(int argc, VALUE *argv, VALUE self, in
...
+	const char *cname  = rb_class2name(rb_obj_class(self));
 	rb_warn("argumtents for %s#encrypt and %s#decrypt were deprecated; "
                 ...
                 cname, cname, cname);
@@ -204,7 +204,7 @@ ossl_cipher_init(int argc, VALUE *argv, VALUE self, in
...
@@ -281,13 +281,13 @@ ossl_cipher_pkcs5_keyivgen(int argc, VALUE *argv, VALU
 	StringValue(vsalt);
...
@@ -309,7 +309,7 @@ ossl_cipher_update_deprecated(VALUE self, VALUE data)
 static VALUE
...
@@ -329,14 +329,14 @@ ossl_cipher_update(int argc, VALUE *argv, VALUE self)
...
+    in = (unsigned char *)RSTRING_PTR(data);
     ...
     GetCipher(self, ctx);
@@ -349,7 +349,7 @@ ossl_cipher_update(int argc, VALUE *argv, VALUE self)
...
+    if (!EVP_CipherFinal_ex(ctx, (unsigned char *)RSTRING_PTR(str), &out_len))
     ...
     assert(out_len <= RSTRING_LEN(str));
     rb_str_set_len(str, out_len);
@@ -417,7 +417,7 @@ ossl_cipher_set_key(VALUE self, VALUE key)
