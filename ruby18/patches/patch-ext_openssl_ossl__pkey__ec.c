...
@@ -186,22 +186,22 @@ static VALUE ossl_ec_key_initialize(int argc, VALUE *a
...
+                const char *name = StringValueCStr(arg);
                 ...
                 if (nid == NID_undef)
@@ -778,14 +778,14 @@ static VALUE ossl_ec_group_initialize(int argc, VALUE 
...
+                const char *name = StringValueCStr(arg1);
                 ...
                 if (nid == NID_undef)
@@ -1092,7 +1092,7 @@ static VALUE ossl_ec_group_get_seed(VALUE self)
     if (seed_len == 0)
         return Qnil;
...
+    return rb_str_new((const char *)EC_GROUP_get0_seed(group), seed_len);
 ...
 /*  call-seq:
@@ -1107,7 +1107,7 @@ static VALUE ossl_ec_group_set_seed(VALUE self, VALUE 
