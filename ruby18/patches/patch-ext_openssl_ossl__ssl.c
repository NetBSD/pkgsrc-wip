...
@@ -86,7 +95,12 @@ static const char *ossl_ssl_attr_readers[] = { "io", "
...
@@ -146,7 +163,7 @@ ossl_sslctx_set_ssl_version(VALUE self, VALUE ssl_meth
 static VALUE
...
@@ -299,7 +316,7 @@ ossl_call_session_get_cb(VALUE ary)
 static VALUE
...
+    rb_ary_push(ary, rb_str_new((const char *)buf, len));
     ...
     if (state) {
@@ -346,7 +363,7 @@ ossl_call_session_new_cb(VALUE ary)
 static VALUE
...
@@ -1010,6 +1113,72 @@ ossl_ssl_read(int argc, VALUE *argv, VALUE self)
 static VALUE
