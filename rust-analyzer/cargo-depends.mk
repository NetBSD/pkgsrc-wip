...
CARGO_CRATE_DEPENDS+=	arbitrary-1.2.2
...
CARGO_CRATE_DEPENDS+=	chalk-derive-0.88.0
CARGO_CRATE_DEPENDS+=	chalk-ir-0.88.0
CARGO_CRATE_DEPENDS+=	chalk-recursive-0.88.0
CARGO_CRATE_DEPENDS+=	chalk-solve-0.88.0
CARGO_CRATE_DEPENDS+=	command-group-2.0.1
...
CARGO_CRATE_DEPENDS+=	derive_arbitrary-1.2.2
...
CARGO_CRATE_DEPENDS+=	tracing-tree-0.2.2
...
CARGO_CRATE_DEPENDS+=	xshell-0.2.3
CARGO_CRATE_DEPENDS+=	xshell-macros-0.2.3
