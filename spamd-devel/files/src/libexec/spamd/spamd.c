...
#ifndef SMTP_BANNER
#define SMTP_BANNER	"spamd IP-based SPAM blocker"
#endif

/* The responses when sent will also include the SMTP number code and the
   carriage return and line feed. */

#ifndef HELO_RESPONSE
#define HELO_RESPONSE	"Hello, spam sender. Pleased to be wasting your time."
#endif

#ifndef RSET_RESPONSE
#define RSET_RESPONSE	"Ok to start over."
#endif

#ifndef MAIL_RESPONSE
#define MAIL_RESPONSE	"You are about to try to deliver spam. Your time will be spent, for nothing."
#endif

#ifndef RCPT_RESPONSE
#define RCPT_RESPONSE	"This is hurting you more than it is hurting me."
#endif

#ifndef DATA_RESPONSE
#define DATA_RESPONSE	"Enter spam, end with \".\" on a line by itself"
#endif

#ifndef NOOP_RESPONSE
#define NOOP_RESPONSE	"2.0.0 OK I did nothing"
#endif

#ifndef UNRECOGNIZED_RESPONSE
#define UNRECOGNIZED_RESPONSE	"5.5.1 Command unrecognized"
#endif
