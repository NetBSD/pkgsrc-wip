...
CARGO_CRATE_DEPENDS+=	async-native-tls-0.3.3
...
CARGO_CRATE_DEPENDS+=	bindgen-0.63.0
...
CARGO_CRATE_DEPENDS+=	build-time-0.1.3
...
CARGO_CRATE_DEPENDS+=	defmt-0.3.8
CARGO_CRATE_DEPENDS+=	defmt-macros-0.3.9
...
CARGO_CRATE_DEPENDS+=	embassy-sync-0.5.0
CARGO_CRATE_DEPENDS+=	embedded-can-0.4.1
CARGO_CRATE_DEPENDS+=	embedded-hal-0.2.7
CARGO_CRATE_DEPENDS+=	embedded-hal-1.0.0
CARGO_CRATE_DEPENDS+=	embedded-hal-async-1.0.0
CARGO_CRATE_DEPENDS+=	embedded-hal-nb-1.0.0
CARGO_CRATE_DEPENDS+=	embedded-io-0.6.1
CARGO_CRATE_DEPENDS+=	embedded-io-async-0.6.1
CARGO_CRATE_DEPENDS+=	embedded-svc-0.27.1
CARGO_CRATE_DEPENDS+=	embuild-0.31.4
...
CARGO_CRATE_DEPENDS+=	envy-0.4.2
CARGO_CRATE_DEPENDS+=	equivalent-1.0.1
CARGO_CRATE_DEPENDS+=	erased-serde-0.3.31
CARGO_CRATE_DEPENDS+=	errno-0.3.9
CARGO_CRATE_DEPENDS+=	esp-idf-hal-0.43.1
CARGO_CRATE_DEPENDS+=	esp-idf-svc-0.48.1
CARGO_CRATE_DEPENDS+=	esp-idf-sys-0.34.1
...
CARGO_CRATE_DEPENDS+=	impl-more-0.1.8
...
CARGO_CRATE_DEPENDS+=	no-std-net-0.5.0
