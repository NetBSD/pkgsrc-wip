...
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.38.20.mod
GO_MODULE_FILES+=	github.com/aws/aws-sdk-go/@v/v1.38.20.zip
...
GO_MODULE_FILES+=	github.com/go-openapi/spec/@v/v0.19.9.mod
GO_MODULE_FILES+=	github.com/go-openapi/spec/@v/v0.19.9.zip
...
GO_MODULE_FILES+=	github.com/hashicorp/terraform-exec/@v/v0.13.2.mod
GO_MODULE_FILES+=	github.com/hashicorp/terraform-exec/@v/v0.13.2.zip
...
GO_MODULE_FILES+=	github.com/hashicorp/terraform-plugin-sdk/v2/@v/v2.5.0.mod
GO_MODULE_FILES+=	github.com/hashicorp/terraform-plugin-sdk/v2/@v/v2.5.0.zip
...
GO_MODULE_FILES+=	github.com/hashicorp/yamux/@v/v0.0.0-20210316155119-a95892c5f864.mod
GO_MODULE_FILES+=	github.com/hashicorp/yamux/@v/v0.0.0-20210316155119-a95892c5f864.zip
...
GO_MODULE_FILES+=	github.com/jinzhu/copier/@v/v0.2.9.mod
GO_MODULE_FILES+=	github.com/jinzhu/copier/@v/v0.2.9.zip
...
GO_MODULE_FILES+=	golang.org/x/crypto/@v/v0.0.0-20210415154028-4f45737414dc.zip
...
GO_MODULE_FILES+=	golang.org/x/net/@v/v0.0.0-20210414194228-064579744ee0.zip
...
GO_MODULE_FILES+=	golang.org/x/tools/@v/v0.1.1-0.20210302220138-2ac05c832e1a.zip
...
GO_MODULE_FILES+=	google.golang.org/genproto/@v/v0.0.0-20210415145412-64678f1ae2d5.mod
GO_MODULE_FILES+=	google.golang.org/genproto/@v/v0.0.0-20210415145412-64678f1ae2d5.zip
...
GO_MODULE_FILES+=	k8s.io/kube-aggregator/@v/v0.21.0.mod
GO_MODULE_FILES+=	k8s.io/kube-aggregator/@v/v0.21.0.zip
GO_MODULE_FILES+=	k8s.io/kube-openapi/@v/v0.0.0-20210305001622-591a79e4bda7.mod
GO_MODULE_FILES+=	k8s.io/kube-openapi/@v/v0.0.0-20210323165736-1a6458611d18.mod
GO_MODULE_FILES+=	k8s.io/kube-openapi/@v/v0.0.0-20210323165736-1a6458611d18.zip
...
GO_MODULE_FILES+=	k8s.io/utils/@v/v0.0.0-20210305010621-2afb4311ab10.zip
...
GO_MODULE_FILES+=	sigs.k8s.io/kustomize/api/@v/v0.8.7.mod
GO_MODULE_FILES+=	sigs.k8s.io/kustomize/api/@v/v0.8.7.zip
...
GO_MODULE_FILES+=	sigs.k8s.io/structured-merge-diff/v4/@v/v4.1.1.mod
GO_MODULE_FILES+=	sigs.k8s.io/structured-merge-diff/v4/@v/v4.1.1.zip
