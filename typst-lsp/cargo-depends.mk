...
CARGO_CRATE_DEPENDS+=	append-only-vec-0.1.2
...
CARGO_CRATE_DEPENDS+=	biblatex-0.7.0
...
CARGO_CRATE_DEPENDS+=	hayagriva-0.2.1
...
CARGO_CRATE_DEPENDS+=	tower-lsp-0.19.0
CARGO_CRATE_DEPENDS+=	tower-lsp-macros-0.8.0
...
CARGO_CRATE_DEPENDS+=	typst-0.0.0
CARGO_CRATE_DEPENDS+=	typst-library-0.0.0
CARGO_CRATE_DEPENDS+=	typst-macros-0.0.0
