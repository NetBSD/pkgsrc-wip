...
umodasu::IxHash - ordered associative arrays for Perl
...
=head1 SYNOPSIS
    ...
    # simple usage
    use umodasu::IxHash;
    tie HASHVARIABLE, umodasu::IxHash [, LIST];
    
    # OO interface with more powerful features
    use umodasu::IxHash;
    TIEOBJECT = umodasu::IxHash->new( [LIST] );
...
=head1 EXAMPLE
    ...
    # simple interface
    $t = tie(%myhash, umodasu::IxHash, 'a' => 1, 'b' => 2);
    ...
    # OO interface
    $t = umodasu::IxHash->new(first => 1, second => 2, third => 3);
