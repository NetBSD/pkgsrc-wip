...
CARGO_CRATE_DEPENDS+=	calendrical_calculations-0.2.3
...
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-4.3.0
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-macros-4.3.0
CARGO_CRATE_DEPENDS+=	codspeed-divan-compat-walltime-4.3.0
...
CARGO_CRATE_DEPENDS+=	fixed_decimal-0.7.1
...
CARGO_CRATE_DEPENDS+=	icu_calendar-2.1.1
CARGO_CRATE_DEPENDS+=	icu_calendar_data-2.1.1
CARGO_CRATE_DEPENDS+=	icu_collator-2.1.1
CARGO_CRATE_DEPENDS+=	icu_collator_data-2.1.1
CARGO_CRATE_DEPENDS+=	icu_collections-2.1.1
CARGO_CRATE_DEPENDS+=	icu_datetime-2.1.1
CARGO_CRATE_DEPENDS+=	icu_datetime_data-2.1.2
...
CARGO_CRATE_DEPENDS+=	icu_pattern-0.4.1
CARGO_CRATE_DEPENDS+=	icu_plurals-2.1.1
CARGO_CRATE_DEPENDS+=	icu_plurals_data-2.1.1
...
CARGO_CRATE_DEPENDS+=	icu_time-2.1.1
CARGO_CRATE_DEPENDS+=	icu_time_data-2.1.1
...
CARGO_CRATE_DEPENDS+=	ixdtf-0.6.4
