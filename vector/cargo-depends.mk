...
CARGO_CRATE_DEPENDS+=	aws-credential-types-1.2.6
...
CARGO_CRATE_DEPENDS+=	aws-sdk-kms-1.75.0
CARGO_CRATE_DEPENDS+=	aws-sdk-s3-1.82.0
CARGO_CRATE_DEPENDS+=	aws-sdk-secretsmanager-1.76.0
CARGO_CRATE_DEPENDS+=	aws-sdk-sns-1.73.0
...
CARGO_CRATE_DEPENDS+=	aws-sigv4-1.3.4
...
CARGO_CRATE_DEPENDS+=	aws-smithy-eventstream-0.60.10
CARGO_CRATE_DEPENDS+=	aws-smithy-http-0.62.3
CARGO_CRATE_DEPENDS+=	aws-smithy-http-client-1.1.1
...
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-1.9.1
CARGO_CRATE_DEPENDS+=	aws-smithy-runtime-api-1.9.0
...
CARGO_CRATE_DEPENDS+=	azure_core-0.25.0
CARGO_CRATE_DEPENDS+=	azure_identity-0.25.0
...
CARGO_CRATE_DEPENDS+=	bollard-0.19.2
CARGO_CRATE_DEPENDS+=	bollard-stubs-1.49.0-rc.28.3.3
...
CARGO_CRATE_DEPENDS+=	databend-client-0.28.2
...
CARGO_CRATE_DEPENDS+=	fraction-0.15.1
...
CARGO_CRATE_DEPENDS+=	goauth-0.16.0
...
CARGO_CRATE_DEPENDS+=	grok-2.4.0
...
CARGO_CRATE_DEPENDS+=	hyperlocal-0.9.1
...
CARGO_CRATE_DEPENDS+=	ipcrypt-rs-0.9.4
...
CARGO_CRATE_DEPENDS+=	redis-0.32.5
...
CARGO_CRATE_DEPENDS+=	schemars-1.0.3
...
CARGO_CRATE_DEPENDS+=	serde-toml-merge-0.3.11
...
CARGO_CRATE_DEPENDS+=	syslog_loose-0.22.0
CARGO_CRATE_DEPENDS+=	syslog_loose-0.23.0
...
CARGO_CRATE_DEPENDS+=	typespec-0.5.0
CARGO_CRATE_DEPENDS+=	typespec_client_core-0.4.0
CARGO_CRATE_DEPENDS+=	typespec_macros-0.4.0
...
CARGO_CRATE_DEPENDS+=	vrl-0.27.0
