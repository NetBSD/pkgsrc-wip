...
#In file included from /tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/jit/JIT.h:41,
#                 from /tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/bytecode/Repatch.cpp:50,
#                 from /tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/cmake-pkgsrc-build/JavaScriptCore/DerivedSources/unified-sources/UnifiedSource-f0a787a9-11.cpp:3:
#/tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/jit/PCToCodeOriginMap.h:52:45: error: 'OpcodeOrigin' has not been declared
#   52 |     WasmOrigin(CallSiteIndex callSiteIndex, OpcodeOrigin opcodeOrigin)
#      |                                             ^~~~~~~~~~~~
#/tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/jit/PCToCodeOriginMap.h:58:5: error: 'OpcodeOrigin' does not name a type; did you mean 'CodeOrigin'?
#   58 |     OpcodeOrigin m_opcodeOrigin { };
#      |     ^~~~~~~~~~~~
#      |     CodeOrigin
#/tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/jit/PCToCodeOriginMap.h: In constructor 'JSC::Wasm::WasmOrigin::WasmOrigin(JSC::CallSiteIndex, int)':
#/tmp/wip/webkit-gtk60/work/webkitgtk-2.52.6/Source/JavaScriptCore/jit/PCToCodeOriginMap.h:54:11: error: class 'JSC::Wasm::WasmOrigin' does not have any field named 'm_opcodeOrigin'
...
PLIST_SRC+=		${.CURDIR}/../../wip/webkit-gtk41/PLIST.webdriver
.else
