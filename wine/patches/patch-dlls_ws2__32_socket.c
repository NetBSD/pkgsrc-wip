...
@@ -836,10 +836,12 @@ static const int ws_ip_map[][2] =
...
@@ -5636,7 +5638,9 @@ int WINAPI WS_setsockopt(SOCKET s, int l
     int woptval;
...
@@ -5847,6 +5851,7 @@ int WINAPI WS_setsockopt(SOCKET s, int l
     case WS_IPPROTO_IP:
         switch(optname)
         {
+#ifdef IP_BLOCK_SOURCE
...
@@ -5863,6 +5868,7 @@ int WINAPI WS_setsockopt(SOCKET s, int l
